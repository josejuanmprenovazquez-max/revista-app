...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(z,u){return"function"==typeof z?function(r){try{m(z(r))}catch(v){p(v)}}:u}var m,p,q=new f(function(z,u){m=z;p=u});this.callWhenSettled_(l(h,m),l(k,p));return q};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
p){function q(r){return function(v){z[r]=v;u--;0==u&&m(z)}}var z=[],u=0;do z.push(void 0),u++,d(l.value).callWhenSettled_(q(z.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
(function(b,c,d,e){function f(n,t,w){return setTimeout(m(n,w),t)}function g(n,t,w){return Array.isArray(n)?(h(n,w[t],w),!0):!1}function h(n,t,w){var B;if(n)if(n.forEach)n.forEach(t,w);else if(n.length!==e)for(B=0;B<n.length;)t.call(w,n[B],B,n),B++;else for(B in n)n.hasOwnProperty(B)&&t.call(w,n[B],B,n)}function k(n,t,w){var B="DEPRECATED METHOD: "+t+"\n"+w+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var D=b.console&&(b.console.warn||b.console.log);D&&D.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,t,w){t=t.prototype;var B=n.prototype=Object.create(t);B.constructor=n;B._super=t;w&&S(B,w)}function m(n,t){return function(){return n.apply(t,arguments)}}function p(n,t){return"function"==typeof n?n.apply(t?t[0]||e:e,t):n}function q(n,t,w){h(r(t),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,w,!1):n.attachEvent(B,w)})}
function z(n,t,w){h(r(t),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,w,!1):n.detachEvent(B,w,!1)})}function u(n,t){for(;n;){if(n==t)return!0;n=n.parentNode}return!1}function r(n){return n.trim().split(/\s+/g)}function v(n,t,w){if(n.indexOf&&!w)return n.indexOf(t);for(var B=0;B<n.length;){if(w&&n[B][w]==t||!w&&n[B]===t)return B;B++}return-1}function x(n){return Array.prototype.slice.call(n,0)}function y(n,t,w){for(var B=[],C=[],D=0;D<n.length;){var E=t?n[D][t]:n[D];
0>v(C,E)&&B.push(n[D]);C[D]=E;D++}w&&(B=t?B.sort(function(J,P){return J[t]>P[t]}):B.sort());return B}function A(n,t){if(t&&t[0]){for(var w,B=t[0].toUpperCase()+t.slice(1),C=0;C<oa.length;){w=(w=oa[C])?w+B:t;if(w in n)return w;C++}return e}}function G(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function F(n,t){var w=this;this.manager=n;this.callback=t;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){p(n.options.enable,[n])&&w.handler(B)};this.init()}
function O(n,t,w){var B=w.pointers.length,C=w.changedPointers.length;var D=t&1&&0===B-C;w.isFirst=!!D;w.isFinal=!!(t&12&&0===B-C);D&&(n.session={});w.eventType=t;t=n.session;B=w.pointers;C=B.length;t.firstInput||(t.firstInput=L(w));1<C&&!t.firstMultiple?t.firstMultiple=L(w):1===C&&(t.firstMultiple=!1);D=t.firstInput;var E=(C=t.firstMultiple)?C.center:D.center;var J=w.center=H(B);w.timeStamp=fa();w.deltaTime=w.timeStamp-D.timeStamp;w.angle=M(E,J);w.distance=K(E,J);D=w.center;E=t.offsetDelta||{};J=
t.prevDelta||{};var P=t.prevInput||{};if(1===w.eventType||4===P.eventType)J=t.prevDelta={x:P.deltaX||0,y:P.deltaY||0},E=t.offsetDelta={x:D.x,y:D.y};w.deltaX=J.x+(D.x-E.x);w.deltaY=J.y+(D.y-E.y);w.offsetDirection=I(w.deltaX,w.deltaY);E=w.deltaTime;D=w.deltaX/E||0;E=w.deltaY/E||0;w.overallVelocityX=D;w.overallVelocityY=E;w.overallVelocity=V(D)>V(E)?D:E;C?(D=C.pointers,D=K(B[0],B[1],Y)/K(D[0],D[1],Y)):D=1;w.scale=D;C?(C=C.pointers,B=M(B[1],B[0],Y)+M(C[1],C[0],Y)):B=0;w.rotation=B;w.maxPointers=t.prevInput?
w.pointers.length>t.prevInput.maxPointers?w.pointers.length:t.prevInput.maxPointers:w.pointers.length;E=t.lastInterval||w;B=w.timeStamp-E.timeStamp;8!=w.eventType&&(25<B||E.velocity===e)?(D=w.deltaX-E.deltaX,E=w.deltaY-E.deltaY,J=D/B||0,P=E/B||0,B=J,C=P,J=V(J)>V(P)?J:P,D=I(D,E),t.lastInterval=w):(J=E.velocity,B=E.velocityX,C=E.velocityY,D=E.direction);w.velocity=J;w.velocityX=B;w.velocityY=C;w.direction=D;t=n.element;u(w.srcEvent.target,t)&&(t=w.srcEvent.target);w.target=t;n.emit("hammer.input",w);
n.recognize(w);n.session.prevInput=w}function L(n){for(var t=[],w=0;w<n.pointers.length;)t[w]={clientX:X(n.pointers[w].clientX),clientY:X(n.pointers[w].clientY)},w++;return{timeStamp:fa(),pointers:t,center:H(t),deltaX:n.deltaX,deltaY:n.deltaY}}function H(n){var t=n.length;if(1===t)return{x:X(n[0].clientX),y:X(n[0].clientY)};for(var w=0,B=0,C=0;C<t;)w+=n[C].clientX,B+=n[C].clientY,C++;return{x:X(w/t),y:X(B/t)}}function I(n,t){return n===t?1:V(n)>=V(t)?0>n?2:4:0>t?8:16}function K(n,t,w){w||(w=pa);var B=
t[w[0]]-n[w[0]];n=t[w[1]]-n[w[1]];return Math.sqrt(B*B+n*n)}function M(n,t,w){w||(w=pa);return 180*Math.atan2(t[w[1]]-n[w[1]],t[w[0]]-n[w[0]])/Math.PI}function W(){this.evEl=za;this.evWin=Aa;this.pressed=!1;F.apply(this,arguments)}function Z(){this.evEl=qa;this.evWin=ra;F.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function aa(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;F.apply(this,arguments)}function T(){this.evTarget=
Ba;this.targetIds={};F.apply(this,arguments)}function U(n,t){var w=x(n.touches),B=this.targetIds;if(t&3&&1===w.length)return B[w[0].identifier]=!0,[w,w];n=x(n.changedTouches);var C=[],D=this.target;var E=w.filter(function(J){return u(J.target,D)});if(1===t)for(w=0;w<E.length;)B[E[w].identifier]=!0,w++;for(w=0;w<n.length;)B[n[w].identifier]&&C.push(n[w]),t&12&&delete B[n[w].identifier],w++;if(C.length)return[y(E.concat(C),"identifier",!0),C]}function ha(){F.apply(this,arguments);var n=m(this.handler,
this);this.touch=new T(this.manager,n);this.mouse=new W(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function sa(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var t={x:n.clientX,y:n.clientY};this.lastTouches.push(t);var w=this.lastTouches;setTimeout(function(){var B=w.indexOf(t);-1<B&&w.splice(B,1)},2500)}}function ia(n,t){this.manager=n;this.set(t)}function Ca(n){if(-1<n.indexOf("none"))return"none";var t=-1<n.indexOf("pan-x"),w=-1<n.indexOf("pan-y");return t&&w?"none":
t||w?t?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function Q(n){this.options=S({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function ta(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function ua(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function ba(n,t){return(t=t.manager)?t.get(n):n}function N(){Q.apply(this,arguments)}function ca(){N.apply(this,
arguments);this.pY=this.pX=null}function ja(){N.apply(this,arguments)}function ka(){Q.apply(this,arguments);this._input=this._timer=null}function la(){N.apply(this,arguments)}function ma(){N.apply(this,arguments)}function da(){Q.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function R(n,t){t=t||{};var w=t.recognizers;t.recognizers=w===e?R.defaults.preset:w;return new na(n,t)}function na(n,t){this.options=S({},R.defaults,t||{});this.options.inputTarget=
this.options.inputTarget||n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ha(this,O);this.touchAction=new ia(this,this.options.touchAction);va(this,!0);h(this.options.recognizers,function(w){var B=this.add(new w[0](w[1]));w[2]&&B.recognizeWith(w[2]);w[3]&&B.requireFailure(w[3])},this)}function va(n,t){var w=n.element;if(w.style){var B;h(n.options.cssProps,function(C,D){B=A(w.style,D);t?(n.oldCssProps[B]=w.style[B],w.style[B]=C):w.style[B]=n.oldCssProps[B]||
""});t||(n.oldCssProps={})}}function Ea(n,t){var w=c.createEvent("Event");w.initEvent(n,!0,!0);w.gesture=t;t.target.dispatchEvent(w)}var oa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),X=Math.round,V=Math.abs,fa=Date.now;var S="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var t=Object(n),w=1;w<arguments.length;w++){var B=arguments[w];if(B!==e&&null!==B)for(var C in B)B.hasOwnProperty(C)&&(t[C]=B[C])}return t}:
Object.assign;var wa=k(function(n,t,w){for(var B=Object.keys(t),C=0;C<B.length;){if(!w||w&&n[B[C]]===e)n[B[C]]=t[B[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,t){return wa(n,t,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var pa=["x","y"],Y=["clientX","clientY"];F.prototype={handler:function(){},init:function(){this.evEl&&q(this.element,this.evEl,this.domHandler);this.evTarget&&
q(this.target,this.evTarget,this.domHandler);this.evWin&&q(G(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&z(this.element,this.evEl,this.domHandler);this.evTarget&&z(this.target,this.evTarget,this.domHandler);this.evWin&&z(G(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},za="mousedown",Aa="mousemove mouseup";l(W,F,{handler:function(n){var t=Ja[n.type];t&1&&0===n.button&&(this.pressed=!0);t&2&&1!==n.which&&(t=4);this.pressed&&(t&4&&
(this.pressed=!1),this.callback(this.manager,t,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},qa="pointerdown",ra="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(qa="MSPointerDown",ra="MSPointerMove MSPointerUp MSPointerCancel");l(Z,F,{handler:function(n){var t=this.store,w=!1,B=n.type.toLowerCase().replace("ms","");B=Ka[B];var C=
La[n.pointerType]||n.pointerType,D="touch"==C,E=v(t,n.pointerId,"pointerId");B&1&&(0===n.button||D)?0>E&&(t.push(n),E=t.length-1):B&12&&(w=!0);0>E||(t[E]=n,this.callback(this.manager,B,{pointers:t,changedPointers:[n],pointerType:C,srcEvent:n}),w&&t.splice(E,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(aa,F,{handler:function(n){var t=Ma[n.type];1===t&&(this.started=!0);if(this.started){var w=x(n.touches);var B=x(n.changedTouches);t&12&&(w=y(w.concat(B),"identifier",!0));w=[w,
B];t&12&&0===w[0].length-w[1].length&&(this.started=!1);this.callback(this.manager,t,{pointers:w[0],changedPointers:w[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ba="touchstart touchmove touchend touchcancel";l(T,F,{handler:function(n){var t=Na[n.type],w=U.call(this,n,t);w&&this.callback(this.manager,t,{pointers:w[0],changedPointers:w[1],pointerType:"touch",srcEvent:n})}});l(ha,F,{handler:function(n,t,w){var B="mouse"==w.pointerType;if(!(B&&w.sourceCapabilities&&
w.sourceCapabilities.firesTouchEvents)){if("touch"==w.pointerType)t&1?(this.primaryTouch=w.changedPointers[0].identifier,sa.call(this,w)):t&12&&sa.call(this,w);else{if(B)a:{B=w.srcEvent.clientX;for(var C=w.srcEvent.clientY,D=0;D<this.lastTouches.length;D++){var E=this.lastTouches[D],J=Math.abs(C-E.y);if(25>=Math.abs(B-E.x)&&25>=J){B=!0;break a}}B=!1}if(B)return}this.callback(n,t,w)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var xa=A(Fa.style,"touchAction"),ya=xa!==e,ea=function(){if(!ya)return!1;
var n={},t=b.CSS&&b.CSS.supports;"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(w){n[w]=t?b.CSS.supports("touch-action",w):!0});return n}();ia.prototype={set:function(n){"compute"==n&&(n=this.compute());ya&&this.manager.element.style&&ea[n]&&(this.manager.element.style[xa]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(t){p(t.options.enable,[t])&&(n=
n.concat(t.getTouchAction()))});return Ca(n.join(" "))},preventDefaults:function(n){var t=n.srcEvent,w=n.offsetDirection;if(this.manager.session.prevented)t.preventDefault();else{var B=this.actions,C=-1<B.indexOf("none")&&!ea.none,D=-1<B.indexOf("pan-y")&&!ea["pan-y"];B=-1<B.indexOf("pan-x")&&!ea["pan-x"];if(C){var E=2>n.distance,J=250>n.deltaTime;if(1===n.pointers.length&&E&&J)return}if(!B||!D)if(C||D&&w&6||B&&w&24)return this.preventSrc(t)}},preventSrc:function(n){this.manager.session.prevented=
!0;n.preventDefault()}};Q.prototype={defaults:{},set:function(n){S(this.options,n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var t=this.simultaneous;n=ba(n,this);t[n.id]||(t[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=ba(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;
var t=this.requireFail;n=ba(n,this);-1===v(t,n)&&(t.push(n),n.requireFailure(this));return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=ba(n,this);n=v(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function t(C){w.manager.emit(C,n)}var w=this,B=this.state;8>B&&t(w.options.event+ta(B));t(w.options.event);
n.additionalEvent&&t(n.additionalEvent);8<=B&&t(w.options.event+ta(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=S({},n);p(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};
l(N,Q,{defaults:{pointers:1},attrTest:function(n){var t=this.options.pointers;return 0===t||n.pointers.length===t},process:function(n){var t=this.state,w=n.eventType,B=t&6;n=this.attrTest(n);return B&&(w&8||!n)?t|16:B||n?w&4?t|8:t&2?t|4:2:32}});l(ca,N,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,t=[];n&6&&t.push("pan-y");n&24&&t.push("pan-x");return t},directionTest:function(n){var t=this.options,w=!0,B=n.distance,C=n.direction,
D=n.deltaX,E=n.deltaY;C&t.direction||(t.direction&6?(C=0===D?1:0>D?2:4,w=D!=this.pX,B=Math.abs(n.deltaX)):(C=0===E?1:0>E?8:16,w=E!=this.pY,B=Math.abs(n.deltaY)));n.direction=C;return w&&B>t.threshold&&C&t.direction},attrTest:function(n){return N.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var t=ua(n.direction);t&&(n.additionalEvent=this.options.event+t);this._super.emit.call(this,n)}});l(ja,N,{defaults:{event:"pinch",
threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(ka,Q,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var t=this.options,w=n.pointers.length===t.pointers,B=n.distance<
t.threshold,C=n.deltaTime>t.time;this._input=n;if(!B||!w||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),this._timer=f(function(){this.state=8;this.tryEmit()},t.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=fa(),this.manager.emit(this.options.event,this._input)))}});l(la,N,{defaults:{event:"rotate",threshold:0,
pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>this.options.threshold||this.state&2)}});l(ma,N,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return ca.prototype.getTouchAction.call(this)},attrTest:function(n){var t=this.options.direction;if(t&30)var w=n.overallVelocity;else t&6?w=n.overallVelocityX:t&24&&(w=n.overallVelocityY);return this._super.attrTest.call(this,
n)&&t&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&V(w)>this.options.velocity&&n.eventType&4},emit:function(n){var t=ua(n.offsetDirection);t&&this.manager.emit(this.options.event+t,n);this.manager.emit(this.options.event,n)}});l(da,Q,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var t=this.options,w=n.pointers.length===t.pointers,B=n.distance<
t.threshold,C=n.deltaTime<t.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&C&&w){if(4!=n.eventType)return this.failTimeout();w=this.pTime?n.timeStamp-this.pTime<t.interval:!0;B=!this.pCenter||K(this.pCenter,n.center)<t.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=B&&w?this.count+1:1;this._input=n;if(0===this.count%t.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},t.interval,this),2):8}return 32},
...
taps:2},["tap"]],[ka]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};na.prototype={set:function(n){S(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var t=this.session;if(!t.stopped){this.touchAction.preventDefaults(n);var w=this.recognizers,
B=t.curRecognizer;if(!B||B&&B.state&8)B=t.curRecognizer=null;for(var C=0;C<w.length;){var D=w[C];2===t.stopped||B&&D!=B&&!D.canRecognizeWith(B)?D.reset():D.recognize(n);!B&&D.state&14&&(B=t.curRecognizer=D);C++}}},get:function(n){if(n instanceof Q)return n;for(var t=this.recognizers,w=0;w<t.length;w++)if(t[w].options.event==n)return t[w];return null},add:function(n){if(g(n,"add",this))return this;var t=this.get(n.options.event);t&&this.remove(t);this.recognizers.push(n);n.manager=this;this.touchAction.update();
return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var t=this.recognizers;n=v(t,n);-1!==n&&(t.splice(n,1),this.touchAction.update())}return this},on:function(n,t){if(n!==e&&t!==e){var w=this.handlers;h(r(n),function(B){w[B]=w[B]||[];w[B].push(t)});return this}},off:function(n,t){if(n!==e){var w=this.handlers;h(r(n),function(B){t?w[B]&&w[B].splice(v(w[B],t),1):delete w[B]});return this}},emit:function(n,t){this.options.domEvents&&Ea(n,t);var w=this.handlers[n]&&this.handlers[n].slice();
if(w&&w.length)for(t.type=n,t.preventDefault=function(){t.srcEvent.preventDefault()},n=0;n<w.length;)w[n](t),n++},destroy:function(){this.element&&va(this,!1);this.handlers={};this.session={};this.input.destroy();this.element=null}};S(R,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:6,
...
!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,p=0,q=0;f.animateInterval=function(z,u){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*(g-1),20);p=$.easing.swing(null,m,f.parameters.left,
f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);q=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:q+"px"});for(var r=0;r<f.side.pageArray.length;r++)if(f.side.pageArray[r])f.side.pageArray[r].onResize(k/2,l);m++;if(20<=m||z>=u){f.animateInterval.stop();f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-
...
(f.y+=d.parameters.height*e/4),BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var m=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,q=e*k,z=0,u=0,r=0,v=0;toolBar&&(z=0===toolBar.getTopHeight()?
0:toolBar.getTopHeight()+10,u=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,r=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,v=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var x=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-v;l=-l-h*e*d.parameters.zoomArea.left/100+r}else x=-l-h*e*d.parameters.zoomArea.left/100+r,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-v;q>windowHeight?(h=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-
u,d=-m-k*e*d.parameters.zoomArea.top/100+z):(h=-m-k*e*d.parameters.zoomArea.top/100+z,d=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-u);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,q){m(p,q,"Sine")}).animation(this,300)}.bind(this),m=function(p,q,z){if(p<q){z=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,q);var u=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,q);p=k(null,p,this.parameters.scale,d-this.parameters.scale,q);q={};q.scale=p;q.tran={x:z,
y:u};z=transformCSS(q);this.css(z)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),p=getHost();if(m&&p!==m){if(g=f.src.replace(m,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(v){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var q=h.getImageData(0,0,k,l),z=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&q){var u=Color(b).split();k=0;for(var r=q.data.length;k<r;k+=4)0<z.data[k+3]&&(q.data[k]!=u.r&&(z.data[k]=q.data[k]/255*u.r),q.data[k+1]!=u.g&&(z.data[k+1]=
q.data[k+1]/255*u.g),q.data[k+2]!=u.b&&(z.data[k+2]=q.data[k+2]/255*u.b));h.putImageData(z,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(v){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
!0;m=new Date;r=(m-l)/20;var v=h-f,x=k-g;0==r?u=z=0:(z=v/r,u=x/r);void 0!=b&&b(z,u);window.clearInterval(p);p=-1}var f,g,h,k,l,m,p=-1,q=!1,z=0,u=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(r){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(r){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",p=-1,q,z,u,r=k.length-l;++p<r;)q=k.charCodeAt(p)<<
16,z=k.charCodeAt(++p)<<8,u=k.charCodeAt(++p),q=q+z+u,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q&63);2==l?(q=k.charCodeAt(p)<<8,z=k.charCodeAt(++p),q+=z,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<2&63)+"="):1==l&&(q=k.charCodeAt(p),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,p,q,z="",u=-1;++u<l;)q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(u)),
...
(function(b){function c(u,r){var v=(u&65535)+(r&65535);return(u>>16)+(r>>16)+(v>>16)<<16|v&65535}function d(u,r,v,x,y,A){u=c(c(r,u),c(x,A));return c(u<<y|u>>>32-y,v)}function e(u,r,v,x,y,A,G){return d(r&v|~r&x,u,r,y,A,G)}function f(u,r,v,x,y,A,G){return d(r&x|v&~x,u,r,y,A,G)}function g(u,r,v,x,y,A,G){return d(v^(r|~x),u,r,y,A,G)}function h(u,r){u[r>>5]|=128<<r%32;u[(r+64>>>9<<4)+14]=r;var v=1732584193,x=-271733879,y=-1732584194,A=271733878;for(r=0;r<u.length;r+=16){var G=v;var F=x;var O=y;var L=A;
v=e(v,x,y,A,u[r],7,-680876936);A=e(A,v,x,y,u[r+1],12,-389564586);y=e(y,A,v,x,u[r+2],17,606105819);x=e(x,y,A,v,u[r+3],22,-1044525330);v=e(v,x,y,A,u[r+4],7,-176418897);A=e(A,v,x,y,u[r+5],12,1200080426);y=e(y,A,v,x,u[r+6],17,-1473231341);x=e(x,y,A,v,u[r+7],22,-45705983);v=e(v,x,y,A,u[r+8],7,1770035416);A=e(A,v,x,y,u[r+9],12,-1958414417);y=e(y,A,v,x,u[r+10],17,-42063);x=e(x,y,A,v,u[r+11],22,-1990404162);v=e(v,x,y,A,u[r+12],7,1804603682);A=e(A,v,x,y,u[r+13],12,-40341101);y=e(y,A,v,x,u[r+14],17,-1502002290);
x=e(x,y,A,v,u[r+15],22,1236535329);v=f(v,x,y,A,u[r+1],5,-165796510);A=f(A,v,x,y,u[r+6],9,-1069501632);y=f(y,A,v,x,u[r+11],14,643717713);x=f(x,y,A,v,u[r],20,-373897302);v=f(v,x,y,A,u[r+5],5,-701558691);A=f(A,v,x,y,u[r+10],9,38016083);y=f(y,A,v,x,u[r+15],14,-660478335);x=f(x,y,A,v,u[r+4],20,-405537848);v=f(v,x,y,A,u[r+9],5,568446438);A=f(A,v,x,y,u[r+14],9,-1019803690);y=f(y,A,v,x,u[r+3],14,-187363961);x=f(x,y,A,v,u[r+8],20,1163531501);v=f(v,x,y,A,u[r+13],5,-1444681467);A=f(A,v,x,y,u[r+2],9,-51403784);
y=f(y,A,v,x,u[r+7],14,1735328473);x=f(x,y,A,v,u[r+12],20,-1926607734);v=d(x^y^A,v,x,u[r+5],4,-378558);A=d(v^x^y,A,v,u[r+8],11,-2022574463);y=d(A^v^x,y,A,u[r+11],16,1839030562);x=d(y^A^v,x,y,u[r+14],23,-35309556);v=d(x^y^A,v,x,u[r+1],4,-1530992060);A=d(v^x^y,A,v,u[r+4],11,1272893353);y=d(A^v^x,y,A,u[r+7],16,-155497632);x=d(y^A^v,x,y,u[r+10],23,-1094730640);v=d(x^y^A,v,x,u[r+13],4,681279174);A=d(v^x^y,A,v,u[r],11,-358537222);y=d(A^v^x,y,A,u[r+3],16,-722521979);x=d(y^A^v,x,y,u[r+6],23,76029189);v=d(x^
y^A,v,x,u[r+9],4,-640364487);A=d(v^x^y,A,v,u[r+12],11,-421815835);y=d(A^v^x,y,A,u[r+15],16,530742520);x=d(y^A^v,x,y,u[r+2],23,-995338651);v=g(v,x,y,A,u[r],6,-198630844);A=g(A,v,x,y,u[r+7],10,1126891415);y=g(y,A,v,x,u[r+14],15,-1416354905);x=g(x,y,A,v,u[r+5],21,-57434055);v=g(v,x,y,A,u[r+12],6,1700485571);A=g(A,v,x,y,u[r+3],10,-1894986606);y=g(y,A,v,x,u[r+10],15,-1051523);x=g(x,y,A,v,u[r+1],21,-2054922799);v=g(v,x,y,A,u[r+8],6,1873313359);A=g(A,v,x,y,u[r+15],10,-30611744);y=g(y,A,v,x,u[r+6],15,-1560198380);
x=g(x,y,A,v,u[r+13],21,1309151649);v=g(v,x,y,A,u[r+4],6,-145523070);A=g(A,v,x,y,u[r+11],10,-1120210379);y=g(y,A,v,x,u[r+2],15,718787259);x=g(x,y,A,v,u[r+9],21,-343485551);v=c(v,G);x=c(x,F);y=c(y,O);A=c(A,L)}return[v,x,y,A]}function k(u){var r,v="",x=32*u.length;for(r=0;r<x;r+=8)v+=String.fromCharCode(u[r>>5]>>>r%32&255);return v}function l(u){var r,v=[];v[(u.length>>2)-1]=void 0;for(r=0;r<v.length;r+=1)v[r]=0;var x=8*u.length;for(r=0;r<x;r+=8)v[r>>5]|=(u.charCodeAt(r/8)&255)<<r%32;return v}function m(u){return k(h(l(u),
8*u.length))}function p(u,r){var v=l(u),x=[],y=[];x[15]=y[15]=void 0;16<v.length&&(v=h(v,8*u.length));for(u=0;16>u;u+=1)x[u]=v[u]^909522486,y[u]=v[u]^1549556828;r=h(x.concat(l(r)),512+8*r.length);return k(h(y.concat(r),640))}function q(u){var r="",v;for(v=0;v<u.length;v+=1){var x=u.charCodeAt(v);r+="0123456789abcdef".charAt(x>>>4&15)+"0123456789abcdef".charAt(x&15)}return r}function z(u,r,v){r?v?u=p(unescape(encodeURIComponent(r)),unescape(encodeURIComponent(u))):(u=p(unescape(encodeURIComponent(r)),
unescape(encodeURIComponent(u))),u=q(u)):u=v?m(unescape(encodeURIComponent(u))):q(m(unescape(encodeURIComponent(u))));return u}"function"===typeof define&&define.amd?define(function(){return z}):"object"===typeof module&&module.exports?module.exports=z:b.md5=z})(this);String.prototype.MD5=function(b){return md5(this)};
...
function imageUrl2DataUrl(b){return new Promise(function(c,d){try{var e=getImage(b)[0];e.onload=function(){var f=document.createElement("canvas");f.width=e.width;f.height=e.height;f.getContext("2d",{willReadFrequently:!0}).drawImage(e,0,0);f=f.toDataURL("image/png",1);c(f)}}catch(f){d(f)}})}
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this,m=d(h);e[m]&&clearTimeout(e[m]);return new Promise(function(p,q){f[m]||(f[m]=[]);f[m].push({resolve:p,reject:q});e[m]=setTimeout(function(){var z,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){switch(r.nextAddress){case 1:return r.setCatchFinallyBlocks(2,3),r.yield(b.apply(l,h),5);case 5:z=r.yieldResult,f[m].forEach(function(v){return v.resolve(z)});
case 3:r.enterFinallyBlock();delete e[m];delete f[m];r.leaveFinallyBlock(0);break;case 2:u=r.enterCatchBlock(),f[m].forEach(function(v){return v.reject(u)}),r.jumpTo(3)}})},c)})}}
function changeBase64ImageColor(b,c){return new Promise(function(d,e){var f=new Image;f.crossOrigin="Anonymous";f.src=b;f.onload=function(){var g=document.createElement("canvas"),h=g.getContext("2d",{willReadFrequently:!0});g.width=f.width;g.height=f.height;h.drawImage(f,0,0);h.globalCompositeOperation="source-atop";h.fillStyle=c;h.fillRect(0,0,g.width,g.height);h.globalCompositeOperation="destination-over";d(g.toDataURL())};f.onerror=function(g){return e(g)}})}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d",{willReadFrequently:!0});l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var p=m.getImageData(0,0,l.width,l.height),q=p.data,z=c?e(c):null,u=d?e(d):{r:0,g:0,b:0,a:0},r=0;r<q.length;r+=4){var v=q[r+3];0===v?(q[r]=u.r,q[r+1]=u.g,q[r+2]=u.b,q[r+3]=void 0!==u.a?u.a:0):0<v&&255>v?z&&(q[r]=Math.round((z.r*v+u.r*(255-v))/255),q[r+1]=Math.round((z.g*v+u.g*(255-v))/255),q[r+2]=Math.round((z.b*v+u.b*(255-v))/255),
q[r+3]=255):z&&(q[r]=z.r,q[r+1]=z.g,q[r+2]=z.b,q[r+3]=void 0!==z.a?z.a:255)}m.putImageData(p,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}
...
var reflection=function(b){var c=new Image;c.onload=function(){var d=null;b.children("canvas")[0]&&(d=$(b.children("canvas")[0]));var e=document.createElement("canvas"),f=e.getContext("2d",{willReadFrequently:!0});b[0].appendChild(e);c.onload=c.onerror=null;var g=this.width,h=this.height;b.children("img")&&g>b.children("img").width()&&(g=b.children("img").width());b.children("img")&&h>b.children("img").height()&&(h=b.children("img").height());var k=.7*h;try{e.style.width=g+"px";e.style.height=k+"px";
e.width=g;e.height=k;e.className="reflect";$(e).css({transform:"translateY(-1px)"});f.save();f.translate(0,h);f.scale(1,-1);f.drawImage(c,0,0,g,h);f.restore();f.globalCompositeOperation="destination-out";var l=f.createLinearGradient(0,0,0,k);l.addColorStop(1,"rgba(255, 0, 0, 1.0)");l.addColorStop(0,"rgba(255, 0, 0, 0)");f.fillStyle=l;f.rect(0,0,g,2*k);f.fill();d&&d.remove()}catch(m){}};c.onerror=function(){c.onload=c.onerror=null};c.src=b.children("img")[0].src};
...
("undefined"!==typeof c?c:"")).trim(),/(^|[\\\/])booklogo\.png(\?.*)?(#.*)?$/i.test(r)))return""},m,p,q,z,u;if((null==(m=window.tmpBookConfig)?0:null==(p=m.power_info)?0:p.power)||(null==(q=window.bookConfig)?0:null==(z=q.power_info)?0:z.power)||(null==(u=window.userInfo)?0:u.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(k());window.eventEmitter.on("loadUserInfo",function(r){return l(k())})}
...
10);tmpBookConfig.topMarginOnMobile=getConfigValue("topMarginOnMobile",10);tmpBookConfig.bottomMarginOnMobile=getConfigValue("bottomMarginOnMobile",10);tmpBookConfig.leftMarginOnMobile=getConfigValue("leftMarginOnMobile",10);tmpBookConfig.rightMarginOnMobile=getConfigValue("rightMarginOnMobile",10);if(isPhone()||isPad()){tmpBookConfig.topMargin=tmpBookConfig.topMarginOnMobile;tmpBookConfig.bottomMargin=tmpBookConfig.bottomMarginOnMobile;tmpBookConfig.leftMargin=tmpBookConfig.leftMarginOnMobile;if("number"!==
typeof tmpBookConfig.rightMarginOnMobile||isNaN(tmpBookConfig.rightMarginOnMobile))tmpBookConfig.rightMarginOnMobile=0;tmpBookConfig.rightMargin=tmpBookConfig.rightMarginOnMobile;tmpBookConfig.phoneFlipShortcutSwitchButtonVisible=getConfigValue("phoneFlipShortcutSwitchButtonVisible",!1);tmpBookConfig.phoneFlipShortcutButton=getConfigValue("phoneFlipShortcutButton",!1);tmpBookConfig.searchbarAlwaysShowOnMobile&&tmpBookConfig.toolbarAlwaysShow&&(tmpBookConfig.topMargin+=50)}else tmpBookConfig.phoneFlipShortcutButton=
!1;tmpBookConfig.visibleAreaLeft=parseFloat(getConfigValue("visibleAreaLeft","0%"));tmpBookConfig.visibleAreaTop=parseFloat(getConfigValue("visibleAreaTop","0%"));tmpBookConfig.visibleAreaRight=parseFloat(getConfigValue("visibleAreaRight","100%"));tmpBookConfig.visibleAreaBottom=parseFloat(getConfigValue("visibleAreaBottom","100%"));tmpBookConfig.visibleAreaLeft=isNaN(tmpBookConfig.visibleAreaLeft)?"0%":tmpBookConfig.visibleAreaLeft;tmpBookConfig.visibleAreaTop=isNaN(tmpBookConfig.visibleAreaTop)?
"0%":tmpBookConfig.visibleAreaTop;tmpBookConfig.visibleAreaRight=isNaN(tmpBookConfig.visibleAreaRight)?"100%":tmpBookConfig.visibleAreaRight;tmpBookConfig.visibleAreaBottom=isNaN(tmpBookConfig.visibleAreaBottom)?"100%":tmpBookConfig.visibleAreaBottom;tmpBookConfig.bleedAreaLeft=parseFloat(getConfigValue("bleedAreaLeft","0%"));tmpBookConfig.bleedAreaTop=parseFloat(getConfigValue("bleedAreaTop","0%"));tmpBookConfig.bleedAreaRight=parseFloat(getConfigValue("bleedAreaRight","0%"));tmpBookConfig.bleedAreaBottom=
...
tmpBookConfig.visibleAreaLeft;tmpBookConfig.visibleAreaTop=tmpBookConfig.bleedAreaTop?tmpBookConfig.bleedAreaTop:tmpBookConfig.visibleAreaTop;tmpBookConfig.visibleAreaRight=tmpBookConfig.bleedAreaRight?100-parseFloat(tmpBookConfig.bleedAreaRight):tmpBookConfig.visibleAreaRight;tmpBookConfig.visibleAreaBottom=tmpBookConfig.bleedAreaBottom?100-parseFloat(tmpBookConfig.bleedAreaBottom):tmpBookConfig.visibleAreaBottom;tmpBookConfig.LinkDownColor=getConfigValue("LinkDownColor","#9C9C9C");tmpBookConfig.LinkAlpha=
getConfigValue("LinkAlpha",.4);tmpBookConfig.googleAnalyticsID=getConfigValue("googleAnalyticsID","");tmpBookConfig.googleTagManagerID=getConfigValue("googleTagManagerID","");tmpBookConfig.language=getConfigValue("language","English");tmpBookConfig.AboutAddress=getConfigValue("AboutAddress","");tmpBookConfig.AboutEmail=getConfigValue("AboutEmail","");tmpBookConfig.AboutMobile=getConfigValue("AboutMobile","");tmpBookConfig.AboutWebsite=getConfigValue("AboutWebsite","");tmpBookConfig.AboutDescription=
getConfigValue("AboutDescription","");tmpBookConfig.AboutAuthor=getConfigValue("AboutAuthor","");tmpBookConfig.totalPageCount=getConfigValue("totalPageCount",1);tmpBookConfig.largePageWidth=getConfigValue("largePageWidth",1440);tmpBookConfig.largePageHeight=getConfigValue("largePageHeight",1728);tmpBookConfig.normalPath=getConfigValue("normalPath","files/page/");tmpBookConfig.largePath=getConfigValue("largePath","files/large/");tmpBookConfig.thumbPath=getConfigValue("thumbPath","files/thumb/");tmpBookConfig.pageSpacing=
getConfigValue("pageSpacing",10);tmpBookConfig.FlipStyle=getConfigValue("FlipStyle","flip");tmpBookConfig.FlipStyle=tmpBookConfig.FlipStyle.toLowerCase();tmpBookConfig.phoneFlipStyle=getConfigValue("phoneFlipStyle",void 0);(isPhone()||isPad())&&void 0!==tmpBookConfig.phoneFlipStyle&&(tmpBookConfig.FlipStyle=tmpBookConfig.phoneFlipStyle.toLowerCase());tmpBookConfig.autoDoublePage=getConfigValue("autoDoublePage","auto");"docview"===tmpBookConfig.FlipStyle&&(tmpBookConfig.autoDoublePage="single");d=
tmpBookConfig.autoDoublePage?tmpBookConfig.autoDoublePage.toLocaleLowerCase():"auto";"single"!=d&&"auto"!=d&&"double"!=d?getConfigValue("autoDoublePage",!0)?tmpBookConfig.showDoublePage="auto":tmpBookConfig.showDoublePage="single":tmpBookConfig.showDoublePage=d;tmpBookConfig.alwaysDoublePageOnMobile=getConfigValue("alwaysDoublePageOnMobile",!1);tmpBookConfig.upsideOnMobile=function(){return isPhone()||isPad()?tmpBookConfig.alwaysDoublePageOnMobile&&window.innerHeight>window.innerWidth?!0:!1:!1};tmpBookConfig.autoSwitchWidePage=
getConfigValue("autoSwitchWidePage",!0);tmpBookConfig.upsideOnMobile()&&"single"!=tmpBookConfig.showDoublePage&&(tmpBookConfig.showDoublePage="double");tmpBookConfig.QRPath=getConfigValue("QRPath","files/extfile/QRURL.png");tmpBookConfig.QRCode=getConfigValue("QRCode",!1);tmpBookConfig.MiniStyle=getConfigValue("MiniStyle",!0);tmpBookConfig.AnnotationButtonVisible=getConfigValue("AnnotationButtonVisible",!1);tmpBookConfig.InstructionsButtonVisible=getConfigValue("InstructionsButtonVisible",!1);tmpBookConfig.showInstructionOnStart=
...
function checkFliphtml5PagesConfig(){var b,c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:b=window.htmlConfig.fliphtml5_pages;if("string"!==typeof b){window.fliphtml5_pages=b;k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(new Promise(function(l,m){setTimeout(function(){try{var p=allocateUTF8(b),q=Module._DeString(p),z=UTF8ToString(q);Module._FreeMemory(q);if(z&&"undefined"!==z){q=z;var u=q.lastIndexOf("]");0<u&&(q=q.substring(0,
...
var VERSION_NAME="6.4.9",BUILD_DATE="2025122401",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
z=0;z<canvasData[b].resources.length;z++)if(1!=canvasData[b].resources[z].type)q++,q>=canvasData[b].resources.length&&k();else{var u=new Image;u.src=getResource(b,z);globalImages[b][z]=u;u.onload=function(){q++;q>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(z){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(u){bookConfig.largePageWidth/bookConfig.largePageHeight>u[0].naturalWidth/u[0].naturalHeight?u.css({width:"auto",height:"100%"}):u.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)p=c[m],p=p.removeStartFrom("?"),q=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),q.attr("src",p),k.append(q),q[0].onload=function(u){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},q[0].onerror=function(u){h++;h==c.length&&
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),p=b.getContext("2d",{willReadFrequently:!0}),q=p.getImageData(0,0,f,g),z=p.createImageData(c,d);q=q.data;for(var u=z.data,r=0;r<d;r++)for(var v=0;v<c;v++){for(var x=4*(v+r*c),y,A=0,G=0,F=0,O=0,L=0,H=0,I=(r+.5)*k,K=Math.ceil((r+1)*k),M=Math.floor(r*k);M<K;M++){var W=Math.abs(I-(M+.5))/m,Z=(v+.5)*h;W*=W;for(var aa=Math.ceil((v+1)*h),T=Math.floor(v*h);T<aa;T++)if(y=
Math.abs(Z-(T+.5))/l,y=Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*q[U+3];G+=y;255>q[U+3]&&(y=y*q[U+3]/250);F+=y*q[U];O+=y*q[U+1];L+=y*q[U+2];A+=y}}u[x]=F/A;u[x+1]=O/A;u[x+2]=L/A;u[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(z,0,0)}
...
!1;return new Promise(function(d,e){this.renderWidth=b;this.renderHeight=c;this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);var f=$("<canvas><canvas/>")[0],g=f.getContext("2d",{willReadFrequently:!0}),h=window.devicePixelRatio||1,k=this.page,l=k.getViewport({scale:1});l=fitPageWidthHeight(b,c,l.width,l.height).x/l.width;l=k.getViewport({scale:l});var m=l.width,p=l.height;isPC()||(m>p?3E3<m*h&&(h=3E3/m):3E3<p*h&&(h=3E3/p));f.width=m*h;f.height=p*h;1==h?(f.style.width=f.width+"px",f.style.height=
f.height+"px"):(f.style.width=m+"px",f.style.height=p+"px");g={canvasContext:g,transform:1!==h?[h,0,0,h,0,0]:null,viewport:l};try{this.renderTask=k.render(g),this.renderTask.promise.then(function(){this.rendered=!0;d(f)}.bind(this))}catch(q){e(q)}}.bind(this))},remove:function(){},destroy:function(){this.loadingTask&&(this.loadingTask.destroy(),this.loadingTask=null);this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);this.loaded=this.rendered=!1},isRepeat:function(){return this.loaded?
...
destroy:function(){this.$image=this.$image[0].onload=null},resizeSvg:function(b,c){if(isPhone()||isPad())b=fitPageWidthHeight(b,c,this.width,this.height),this.scale(b.x,b.y)}}),ImageArrayLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,m,p,q,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(1==u.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=
...
25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,z){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,v=$.easing["easeInOut"+z],x=$.easing["easeOut"+z];z=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(z=v(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(r*r-z*z):r-f*Math.sqrt(u*u-z*z));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:z,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,
...
l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,z){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,v=$.easing["easeInOut"+z],x=$.easing["easeOut"+z];z=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(z=v(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(r*r-z*z):r-f*Math.sqrt(u*u-z*z));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:z,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})):(d=void 0,z=transformCSS({origin:g,scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})));q.setCSSByStyle(z);if(q.page.pageFlipShadow){var u=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});q.page.pageFlipShadow&&q.page.pageFlipShadow.setCSSByStyle(u)}}}return{x:m,y:p}}catch(r){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);
...
this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],this.pageBackArray[d]]},getMovedXByIndex:function(b){var c=this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){var m=this;try{var p=1,q=1;p=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);q=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(u){if(u){var r=
transformCSS({tran:l?l:{x:0,y:0},scale:{x:p,y:q},origin:g});if(m.isCoverPage(u.pageIndex))if(u.tran=l?l:{x:0,y:0},u.scale={x:p,y:q},u.rotateY){u.$page[0].style.removeProperty("transform-origin");var v;r=transformCSS({scale:{x:p,y:q},perspective:6E3,rotateY:null!=(v=u.rotateY)?v:0})}else{var x;r=transformCSS({origin:g,scale:{x:p,y:q},perspective:6E3,rotateY:null!=(x=u.rotateY)?x:0})}u.setCSSByStyle(r);r=h?transformCSS({scale:{x:k.x/p,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});u.page.pageFlipShadow&&
u.page.pageFlipShadow.setCSSByStyle(r)}};for(d=0;d<b.length;d++){var z=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(z)}return{x:p,y:q}}catch(u){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&pageList[b[f]-1]?pageList[b[f]-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight}):
...
window.parent!=window.self&&"undefined"===typeof BookPreviewPublic?new Promise(function(d){function e(h){if(h.data&&"PARENT_DOMAIN"===h.data.type){f=!0;clearTimeout(g);window.removeEventListener("message",e);var k="string"===typeof bookConfig.domainAccess?bookConfig.domainAccess.split(/[,;]/).map(function(m){return m.trim()}):Array.isArray(bookConfig.domainAccess)?bookConfig.domainAccess.map(function(m){return m.trim()}):[];k=k.map(function(m){return m.replace(/^https?:\/\//,"").split(":")[0].toLowerCase()});
