...
function resizeComponents(){if(global.printBody)printBody.onResize();if(global.downLoadBody)downLoadBody.onResize();if(global.helpBody)helpBody.onResize();if(global.aboutBody)aboutBody.onResize();if(global.sharePanel)sharePanel.onResize();if(global.languagePanel)languagePanel.onResize();if(global.frmTableOfContent)frmTableOfContent.onResize();if(global.bookmark)bookmark.onResize();if(bookConfig.AnnotationButtonVisible&&global.annotationPannel)global.annotationPannel.onResize()};var PcAboutForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super();this.bookReadTimesVisible()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7),color:this.fontColor});this.content.css({"background-color":this.fontColor,color:this.mainColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=
$("<div class='about_content'></div>");this.stage.append(this.content);this.content2=$("<div class='content2'></div>");(bookConfig.CompanyLogoFile||bookConfig.AboutDescription)&&this.content.append(this.content2);this.initSwiper();this.content2.append(this.aboutSwiper);this.initLogo();this.content.append(this.content2);this.content1=$("<div class='content1'></div>");this.content.append(this.content1);this.content1.append(this.author);this.content1.append(this.address);this.content1.append(this.email);
this.content1.append(this.website);this.content1.append(this.mobile);this._super()},bookReadTimesVisible:function(){var a=setInterval(function(){try{this.ReadTimes=global.aboutReadTimes?global.aboutReadTimes:0,0<this.ReadTimes?(this.content1.append(this.views),clearInterval(a)):10<this.elements.iRead&&clearInterval(a)}catch(b){}}.bind(this),1E3)},initLogo:function(){bookConfig.CompanyLogoFile||bookConfig.AboutDescription?this.content2.css({display:"block"}):this.content2.css({display:"none"});bookConfig.AboutDescription?
bookConfig.CompanyLogoFile?(this.logo.css({left:"0",transform:"translate(0, 0)"}),bookConfig.RightToLeft&&this.logo.css({left:"auto"}),this.aboutSwiper.css({width:"275px"})):this.aboutSwiper.css({width:"100%"}):this.logo.css({left:"50%",transform:"translate(-50%, 0)"});this.content2.find(this.logo)[0]||(this.content2.append(this.logo),bookConfig.AboutWebsite&&this.logo.attr("href",bookConfig.AboutWebsite))},initSwiper:function(){this.aboutSwiper=$("<div class='aboutSwiper stage'></div>");this.aboutSwiperList=
$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar' style='background:"+this.mainColorObj.rgba(.5)+"'></div>");this.aboutSwiper.append(this.aboutSwiperList);this.aboutSwiperList.append(this.description);this.aboutSwiper.append(this.progress);this.progress.append(this.progressBar);this.aboutSwiper.css({display:"inline-block",width:"265px",height:"105px"});bookConfig.CompanyLogoFile||this.aboutSwiper.css({width:"371px"});this.aboutSwiper.scroll({},
Direction.top,"win10")},onShow:function(){this._super();this.aboutSwiper.refreshData()}}).extend(PcAboutFrame);var PcBookmarkItem=Class({create:function(a,b){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;a.fontColor=this.mainColor;this._super(a,b)}}).extend(BookmarkItem);var PcBookmarkListPanel=Class({create:function(a){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor);this._super(a)},onCreate:function(){this.progressBar.css({"background-color":this.mainColorObj.rgba(.25)})},newItem:function(a){return new PcBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel);var PcBookmarkForm=Class({create:function(a){this._super(a)},onCreate:function(){this.initColorCss();this.bookmarkListPanel.onCreate()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7),color:this.fontColor});this.content.css({"background-color":this.fontColor,color:this.mainColor});this.leftAddPage.css({"background-color":this.mainColor,color:this.fontColor});this.rightAddPage.css({"background-color":this.mainColor,color:this.fontColor});this.remove.css({"background-color":this.mainColor,
color:this.fontColor});this.bookmarkListTitle.css({"background-color":this.mainColor,color:this.fontColor});this.bookmarkListPanel.initColorCss()},resetFormItems:function(){this.bookmarkListPanel.resetSwiperHtml()},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='bookmark_content'></div>");this.stage.append(this.content);var a=$("<p class='inputForm'></p>");
a.append(this.input);a.append(this.colorSelection);this.content.append(a);this.content.append(this.leftAddPage);this.content.append(this.rightAddPage);this.content.append(this.bookmarkListTitle);this.content.append(this.bookmarkListPanel.bookmarkSwiper);this.content.append(this.remove);this.parent.append(this.stage);this.refreshPanel()},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();this.stage.find(".bookmark_content").css({height:a-
87+"px"});var b=toolBar.getTopHeight()+10;this.width=240;this.height=a-40;this.maxHeight=this.height-188;this.stage.css({height:this.height+"px",top:b+"px"});this.bookmarkListPanel.onResize(this.width,this.maxHeight);this.refreshPanel()}}).extend(PcBookmarkFrame);var PcHelpForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7),color:this.fontColor});this.content.css({"background-color":this.fontColor,color:this.mainColor})},resetColorChanged:function(){this._super();!bookConfig.helpContentFileURL&&this.image&&(this.image[0].colorChanged=!1)},changeIconColor:function(){this.close&&this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);
!bookConfig.helpContentFileURL&&this.image&&this.image.changeButtonColor(this.mainColor)},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='help_content'></div>");this.stage.append(this.content);this.content.append(this.image);this.title1&&this.content.append(this.title1);this.title2&&this.content.append(this.title2);this._super()}}).extend(PcHelpFrame);var PcPrintForm=Class({create:function(a){this.elements=new PrintElements(this);this._super(a)},onCreate:function(){this.initColorCss();this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7*this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.printButton.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.printDiv.css({"border-left":"1px solid "+
this.mainColorObj.rgba(.25)})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='content'></div>");this.stage.append(this.content);this.content.append(this.pictureListForm.getDom());this.printDiv=$("<div class='printDiv'></div>");this.appendPrintOptions(this.printDiv);this.content.append(this.printDiv);this._super()},changeItemColor:function(){this.printCurrent.changeButtonColor(this.mainColor);
this.printRange.changeButtonColor(this.mainColor);this.printAll.changeButtonColor(this.mainColor)},onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.pictureListForm.leftBtn.changeButtonColor(this.mainColor);this.pictureListForm.rightBtn.changeButtonColor(this.mainColor);this.changeItemColor()}}).extend(PcPrintFrame);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({create:function(a){this._super(a)},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7),color:this.fontColor});this.content.css({"background-color":this.fontColor,color:this.mainColor});this.progressBar.css({"background-color":this.mainColorObj.rgba(.8)})},resetFormItems:function(){this.elements.refreshItems(this.mainColor)},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):
this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='tableofcontent_content'></div>");this.stage.append(this.content);this.content.append(this.tableofcontentSwiper);this.parent.append(this.stage)},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=300;this.height=a-40;this.maxHeight=this.height-68;this.tableofcontentSwiper.css({height:a-
67+"px"});this.stage.css({height:this.height+"px",top:b+"px"});this.elements.refresh()}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7),color:this.fontColor});this.content.css({"background-color":this.fontColor,color:this.mainColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='videoGallery_content'></div>");
this.stage.append(this.content);this.content.append(this.video);this.content.append(this.info);if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoSwiper);this.content.append(a)}else this.stage.css("width","335px"),this.content.css("width","315px");this._super()}}).extend(PcVideoGalleryFrame);var PcShareForm=Class({create:function(a){this._super(a)},onCreate:function(){bookConfig.addCurrentPage&&this.content.css({height:"215px"});this.shareCode.css({"margin-top":"2px"});this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7*this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.codeBox.find(".qrcode").css({"background-color":this.mainColor,color:this.fontColor});
this.codeBox.find(".miniProgram").css({"background-color":this.mainColor,color:this.fontColor});this.copy1.css({"background-color":this.mainColor,color:this.fontColor})},initHtml:function(){var a=this;this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='share_content'></div>");this.initSwiper();this.stage.append(this.content);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);
this.getQrCodeStatus().then(function(b){b&&(a.content.append(a.codeBox),bookConfig.SmallProgramUrl||a.codeBox.find(".qrcode").css({"border-top-right-radius":"4px","border-bottom-right-radius":"4px"}))}).catch(function(b){console.error("Error getting QR code status:",b)});this.swiperContainer.append(this.sharePanelTitle);this.content.append(this.swiperContainer);this.linkBox.append(this.linkArea).append(this.copy1);this.content.append(this.shareCurrentPageBox);this.content.append(this.linkBox);this._super()},
changeItemColor:function(){this.elements.fontColor=this.mainColor;this.shareCurrentCheck.changeButtonColor(this.mainColor)}}).extend(PcShareFrame);var PcDownloadForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7*this.formOpacity),color:this.fontColor});this.downloadContent.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.downloadButton.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});bookConfig.RightToLeft?this.content1.css({"border-left":"1px solid "+
this.mainColorObj.rgba(.3)}):this.content1.css({"border-right":"1px solid "+this.mainColorObj.rgba(.3)})},resetColorChanged:function(){this._super();this.dragIcon[0].colorChanged=!1},resetIconSrc:function(){this._super();this.dragIcon.attr("src",this.dragUrl)},changeIconColor:function(){this._super();this.dragIcon.changeButtonColor(this.fontColor);this.changeItemColor()},changeItemColor:function(){this.downloadCurrent.changeButtonColor(this.mainColor);this.downloadAttachments.changeButtonColor(this.mainColor);
