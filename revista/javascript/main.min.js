...
var AssistantConfig=Class({create:function(){this.playMode=this.spiritType=0;this.defaultPauseTimeWhenEmpty=this.defaultPauseTimeWhenFinished=3E3;this.resources=assistantConfig.Assistant.Resources}}),Spirit=Class({create:function(){this.$spirit=$("<div class='spirit stand'></div>");this.$person=$("<div class='person'></div>");this.$shadow=$("<img class='shadow' src='"+uiBaseURL+"shadow.png'></img>");this.$spirit.append(this.$person);bookConfig.isShowAssistantPerson?this.$spirit.append(this.$shadow):
this.$spirit.addClass("noPerson");$("body").append(this.$spirit)},talk:function(){bookConfig.isShowAssistantPerson&&(this.$spirit.removeClass("stand"),this.$spirit.addClass("talk"))},stand:function(){bookConfig.isShowAssistantPerson&&(this.$spirit.removeClass("talk"),this.$spirit.addClass("stand"))},show:function(){this.$spirit.show()},hide:function(){this.$spirit.hide()}}),Alice=Class({create:function(){this._super();bookConfig.isShowAssistantPerson&&this.$spirit.addClass("Alice")}}).extend(Spirit),
Peter=Class({create:function(){this._super();bookConfig.isShowAssistantPerson&&this.$spirit.addClass("Peter")}}).extend(Spirit),LyricRotation=Class({lrcFile:"",$player:null,currentText:"",create:function(){this.initHtml()},updateResource:function(a,b){bookConfig.isFlipPdf&&a.startsWith("./")&&(a="."+a);if(a==this.lrcFile&&b==this.$player&&this.isloadSuccess)this.show();else{this.lrcFile=a;this.$player=b;var c=this;$.ajax({url:a,headers:{contentType:"application/x-www-form-urlencoded"},success:function(d){this.isloadSuccess=
!0;c.successFun(d)}.bind(this),error:function(d){this.hide();error&&error(d)}.bind(this)})}},successFun:function(a){var b=this.parseLyric(a);b?(this.show(),b&&(this.renderLyric(b),this.updateLyric(b),this.tmp.refreshData(),this.$player.bind("timeupdate",function(){this.updateLyric(b)}.bind(this)))):this.hide()},parseLyric:function(a){var b=a.split("\n"),c=/\[\d*:\d*((\.|:)\d*)*\]/g;if(!a.match(c))return a;a={};for(var d=0;d<b.length;d++){var e=decodeURIComponent(b[d]),f=e.match(c);if(f){e=e.replace(c,
"");for(var g=0,h=f.length;g<h;g++){var l=f[g],m=Number(String(l.match(/\[\d*/i)).slice(1));l=Number(String(l.match(/:\d*/i)).slice(1));a[60*m+l]=e}}}return a},renderLyric:function(a){this.$lyrics.html("");if("string"==typeof a)this.$lyrics.append(a);else{this.currentText=void 0;var b=0,c;for(c in a){var d=a[c];if(d){var e=$("<li>"+d+"</li>");this.$lyrics.append(e);a[c]={index:b++,text:d}}}}},updateLyric:function(a){if("string"!=typeof a&&a&&(a=a[parseInt(this.$player[0].currentTime)])){var b=a.text;
b!=this.currentText&&(this.locationLrc(a),this.currentText=b)}},locationLrc:function(a){this.$lyric.find(".on").removeClass("on");a=this.$lyric.find("li:nth-child("+(a.index+1)+")");a.addClass("on");a=Math.min(0,this.$lyrics.offset().top-a.offset().top-10+35);a=transformCSS({tran:{x:0,y:a}});this.$lyrics.css(a)},initHtml:function(){this.$lyric=$("<div class='lyric'></div>");bookConfig.isShowAssistantPerson||this.$lyric.addClass("noPerson");this.tmp=$("<div class='stage' style='width:100%;height:100%;position:relative;overflow:hidden;'></div>");
this.$lyrics=$("<div class='lyrics swiper'></div>");this.progress=$("<div class='progress' style='width: 15px;height: 5px;position: absolute;bottom: 0;cursor: pointer;position:absolute;right:0;z-index:111;'></div>");this.progressBar=$("<div class='progressBar' style='background:#bbb;width: 5px;height: 5px;background: rgba(255,255,255,0.25);position: absolute;right: 0;top: 0;cursor: pointer;border-radius: 2px;'></div>");this.progress.append(this.progressBar);this.tmp.append(this.progress);this.tmp.append(this.$lyrics);
this.$lyric.append(this.tmp);this.$lyric.append($("<span class='arrow'></span>"));$("body").append(this.$lyric);this.tmp.scroll({},Direction.top,"win10")},show:function(){this.$lyric.show(100)},hide:function(){this.$lyric.hide()}}),AssistantPlayer=Class({audio:null,$player:null,playMode:0,audio_file:"",index:0,start:!1,end:!1,resource:null,create:function(){this.audio=new Media($("<audio></audio>"),"audio");this.$player=this.audio.$media;this.$player.bind("play",function(){this.audioPlay()}.bind(this));
this.$player.bind("ended",function(){this.end=!0;this.callback()}.bind(this))},updateResource:function(a,b){if(a){var c=a.file;bookConfig.isFlipPdf&&c.startsWith("./")&&(c="."+c);this.audio_file!=c&&(this.audio_file=c,this.$player.attr("src",c));this.index++;this.end=this.start=!1;this.resource=a;this.callback=b}},audioPlay:function(){if(!this.start&&this.resource){var a=this.parseTime(this.resource.time,this.$player[0].duration);this.start||(this.$player[0].currentTime=a[0],this.start=!0)}},timeupdate:function(){if(!this.end&&
this.start){var a=this.parseTime(this.resource.time,this.$player[0].duration);parseInt(this.$player[0].currentTime)>a[1]&&!this.end&&(this.end=!0,this.callback())}},parseTime:function(a,b){if(!a)return[0,parseInt(b)];a=a.split("~");var c=[];for(i=0;i<a.length;i++){var d=a[i];0>d.indexOf("%")&&0>d.indexOf("s")&&(d=parseInt(b*parseFloat(d)));"string"==typeof d&&0<d.indexOf("%")&&(d=parseInt(b*parseFloat(d.remove("%"))/100));"string"==typeof d&&0<d.indexOf("ms")&&(d=parseInt(d.remove("ms")/1E3));"string"==
typeof d&&0<d.indexOf("s")&&(d=parseInt(d.remove("s")));d=Number.between(d,0,parseInt(b));c.push(d)}return c},play:function(){this.$player[0].currentTime=0;this.audio.play()},pause:function(){this.audio.pause()}});AssistantConfig=Class({create:function(){this.playMode=this.spiritType=0;this.defaultPauseTimeWhenEmpty=this.defaultPauseTimeWhenFinished=3E3;this.resources=assistantConfig.Assistant.Resources}});
var Assistant=Class({spirit:null,lyric:null,$player:null,player:null,resource:{},create:function(){this.playMode=assistantConfig.Assistant.PlayInfo.playMode;this.defaultPauseTimeWhenFinished=assistantConfig.Assistant.PlayInfo.defaultPauseTimeWhenFinished;this.defaultPauseTimeWhenEmpty=assistantConfig.Assistant.PlayInfo.defaultPauseTimeWhenEmpty;this.visible=!0;this.initSpirit();this.initPlayer();this.initLyric()},initSpirit:function(){var a=assistantConfig.spirit.type?assistantConfig.spirit.type:
0;0==a&&(this.spirit=new Alice);1==a&&(this.spirit=new Peter);this.spirit&&this.spirit.stand();this.initControlBar()},initControlBar:function(){this.$controlBar=$("<div class='assist-control'></div>");this.close=$("<div class='assist-btn assist-close'><span class='assist-icon'></span></div>");this.$play=$("<div class='assist-btn assist-play assist-pause'><span class='assist-icon'></span></div>");this.$next=$("<div class='assist-btn assist-next'><span class='assist-icon'></span></div>");this.$prev=
$("<div class='assist-btn assist-prev'><span class='assist-icon'></span></div>");this.$sound=$("<div class='assist-btn assist-sound'><span class='assist-icon'></span></div>");this.$controlBar.append(this.$play).append(this.$next).append(this.$prev).append(this.$sound);this.spirit.$spirit.append(this.$controlBar).append(this.close);this.initShowButton();this.initControlEvent()},initShowButton:function(){this.assistantButton=$("<div class='assistantButton' style='display:none;'></div>");$("body").append(this.assistantButton)},
initControlEvent:function(){this.$play.bind("click",function(){this.changePlayCase()}.bind(this));this.$sound.bind("click",function(){this.changeSound()}.bind(this));this.$next.bind("click",function(){this.nextEvent()}.bind(this));this.$prev.bind("click",function(){this.prevEvent()}.bind(this));this.close.bind("click",function(){this.pause();this.hide()}.bind(this));this.assistantButton.bind("click",function(){this.show();this.refresh()}.bind(this))},changePlayCase:function(){assistantConfig.Assistant.Resources.Pages.pages[this.pageIndex-
1]&&(this.player.$player[0].paused?this.play():this.pause())},changeSound:function(){1==this.player.$player[0].volume?(this.$sound.addClass("assist-muted"),this.player.$player[0].volume=0):(this.$sound.removeClass("assist-muted"),this.player.$player[0].volume=1)},nextEvent:function(){nextPageFun("assistant")},prevEvent:function(){previousPageFun("assistant")},initPlayer:function(){this.player||(this.player=new AssistantPlayer)},initLyric:function(){this.lyric||(this.lyric=new LyricRotation)},refresh:function(){this.timeout&&
window.clearTimeout(this.timeout);var a=BookInfo.getCurrentPages(),b=a[0];2==a.length&&(b=Math.min(a[0],a[1]));assistantConfig.Assistant.Resources.Pages.pages[b-1]||(b=Math.max(a[0],a[1]));this.updateResource(b)},updateResource:function(a){if(this.visible)if(this.pageIndex=a,a=assistantConfig.Assistant.Resources.Pages.pages[a-1])if(this.audioSrc=assistantConfig.Assistant.Resources.mp3[a.mp3],this.audioSrc.lrc?this.lyric.updateResource(this.audioSrc.lrc,this.player.$player):this.lyric.hide(),a.mp3==
this.resource.mp3)this.play();else if((this.resource=a)&&this.resource.mp3)this.audioSrc.file?(this.audioSrc.time=a.time,this.player.updateResource(this.audioSrc,this.playEnd.bind(this)),this.play()):this.playEnd();else{a=BookInfo.getCurrentPages();var b=a[0],c=a[1];2==a.length&&(b=Math.min(a[0],a[1]));2==a.length&&(c=Math.max(a[0],a[1]));this.pageIndex==b&&void 0!=c?this.updateResource(c):this.playEnd()}else this.lyric.hide(),this.pause()},playEnd:function(){this.pause();var a=BookInfo.getCurrentPages(),
b=a[0],c=a[1];2==a.length&&(b=Math.min(a[0],a[1]));2==a.length&&(c=Math.max(a[0],a[1]));this.pageIndex==b&&void 0!=c?this.updateResource(c):1!=this.playMode&&(this.timeout=this.resource?window.setTimeout(function(){nextPageFun("assistant")},parseInt(this.defaultPauseTimeWhenFinished)):window.setTimeout(function(){nextPageFun("assistant")},parseInt(this.defaultPauseTimeWhenEmpty)))},play:function(){this.resource&&assistantConfig.Assistant.Resources.mp3[assistantConfig.Assistant.Resources.Pages.pages[this.pageIndex-
...
1)-40;this.searchSwiper.css("height",this.height-121+"px");this.searchPageSwiper.css({display:"none"})},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=287;this.height=a-40;this.stage.css({height:this.height+"px",top:b+"px"});this.searchSwiper.css("height",this.height-101+"px");this.elements.refresh()}}).extend(PcSearchFrame);var phoneGotoPage=Class({create:function(a){this.mainColor=Color(bookConfig.toolbarColor);this.iconColor=Color(bookConfig.iconColor);this.menu=$("<div id='menu' style='position:absolute;width:100%;height:90px;z-index:98;bottom:-100px;overflow:hidden;'></div>");this.background=$("<div id='background' style='position:absolute;width:100%;height:90px;'></div>");this.contentBox=$("<div id='contentBox' class='phoneGotoPageContent' style='position:absolute;width:100%;height:90px;'></div>");this.direction=
...
try{if((isPhone()||isPad())&&window.htmlConfig&&window.htmlConfig.phoneTemplate){var $jscomp$optchain$tmp2146899222$0,phoneTemplateName=null==($jscomp$optchain$tmp2146899222$0=window.htmlConfig.phoneTemplate)?void 0:$jscomp$optchain$tmp2146899222$0.name,$jscomp$optchain$tmp2146899222$1,phoneTemplatePath=null==($jscomp$optchain$tmp2146899222$1=window.htmlConfig.phoneTemplate)?void 0:$jscomp$optchain$tmp2146899222$1.path;if(phoneTemplateName&&phoneTemplatePath&&["neat","classical"].includes(phoneTemplateName.toLowerCase())){var toolbarUrl=
...
!1;this.stage.animate({left:"-300px"},400,function(){this.onHide()}.bind(this))}}).extend(FormFrame);var ThumbnailForm=Class({create:function(a){this.direction=0;this.height=130;this.topLength=10;this.margin=30;this._super(a);window.mutexForms||(window.mutexForms=[]);window.mutexForms.push(this)},initHtml:function(){this.stage=$("<div class='thumbnail_win10'></div>");this.stage.append(this.thumbnailSwiper,this.topTitle);this.stage.append(this.pageCaption);this.parent.append(this.stage)}}).extend(ThumbnailFrame);var toolbar_icons={First:"",prev:"",
next:"",
Last:"",home:"",
ZoomIn:"",
ZoomOut:"",
search:"",
thumbnails:"",
tableOfContent:"",
bookmark:"",
autoPlay:"",
stopAutoPlay:"",
soundOn:"",
soundOff:"",
annotation:"",
videoGallery:"",
photoGallery:"",
sharethis:"",
print:"",
message:"",download:"",
fullscreen:"",
exitFullscreen:"",
languageChange:"",
about:"",
Help:"",
moreBar:"",
backward:"",
forward:"",
...
emailButton:"",
wechat:"",
magnifier:"",
text:"iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAFFJREFUeNrslMENACAIA6lx/5XrBApBSTBpn/0cUAAkrVLDivU/YG78bDBo08GuKh68VAbIjCUKwM3sPQBeBKxDE0CA+C+i46F9B9AWlWoJMAAv1wg7wG4MlAAAAABJRU5ErkJggg==",phone:"",
...
previous_normal_down:"",
next_normal_down:"",
...
bookConfig.ToolBarVisible&&(this.parent.append(this.topBar),this.parent.append(this.bottomBar));bookType!=BookType.catalog_book&&bookConfig.flipshortcutbutton&&(this.parent.append(this.leftBar),this.parent.append(this.rightBar),this.showFirstOrLast());this.topBar.append(this.logoBar);bookConfig.appLogoIcon||this.topBar.css({display:"none",height:"0"});this.bottomBar.append(this.buttonBar);bookConfig.RightToLeft?this.rightBar.hide():this.leftBar.hide();this.initPageButtons()},initPageButtons:function(){this.btnFirst=
this.pickButton("first");this.btnPrevious=this.pickButton("previous");this.btnNext=this.pickButton("next");this.btnLast=this.pickButton("last");rightToLeft?(this.btnNext.addTo(this.leftBar),this.btnNext.setPosition(10,10),bookConfig.isFirstLastShortcutVisible&&this.btnLast.addTo(this.leftBar),this.btnLast.setPosition(10,90),this.btnPrevious.addTo(this.rightBar),this.btnPrevious.setPosition(10,10),bookConfig.isFirstLastShortcutVisible&&this.btnFirst.addTo(this.rightBar),this.btnFirst.setPosition(10,
90)):(this.btnPrevious.addTo(this.leftBar),this.btnPrevious.setPosition(10,10),bookConfig.isFirstLastShortcutVisible&&this.btnFirst.addTo(this.leftBar),this.btnFirst.setPosition(10,90),this.btnNext.addTo(this.rightBar),this.btnNext.setPosition(10,10),bookConfig.isFirstLastShortcutVisible&&this.btnLast.addTo(this.rightBar),this.btnLast.setPosition(10,90));var a=bookConfig.flipShortcutButtonColor||bookConfig.iconColor;this.btnNext.changeColor(a);this.btnLast.changeColor(a);this.btnPrevious.changeColor(a);
this.btnFirst.changeColor(a);this.initPageButton(this.btnFirst);this.initPageButton(this.btnPrevious);this.initPageButton(this.btnNext);this.initPageButton(this.btnLast)},resetButtonColor:function(){this._super();for(var a=bookConfig.flipShortcutButtonColor||bookConfig.iconColor,b=[this.btnFirst,this.btnPrevious,this.btnNext,this.btnLast],c=0;c<b.length;c++){var d=b[c];d.resetImg();d.color=Color(a);d.fontColor=Color(bookConfig.iconFontColor);d.changeIconColor(a);d.changeCaptionColor(bookConfig.iconFontColor)}},
initPageButton:function(a){a.changeColor();a.$button.attr("class","pageButton");var b=bookConfig.flipShortcutButtonBackgroundColor||this.color.rgba(bookConfig.ToolBarAlpha);a.$button.css({background:b});a.$button.mouseEnterJump()},setButtonTitle:function(a){var b=a.getClassName();"LastPageButton"==b||"NextPageButton"==b||"FirstPageButton"==b||"PreviousPageButton"==b?a.setTitle(""):"WeChatShareButton"==a.getClassName()?global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,
margin:10,padding:10,direction:2,arrowHeight:12,arrowWidth:12}):"TelephoneNumberButton"==a.getClassName()?global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,margin:4,padding:15,arrowHeight:8,arrowWidth:8}):(b=new SolidArrowTextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor,margin:3,padding:6,direction:2,arrowHeight:4,arrowWidth:4}),a.setTitle(b))},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);
global.moreBar=this.extendedBar},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},onResize:function(a,b){if(this.isRenderToolbar){a=void 0==a?this.parent.width():parseInt(a);b=void 0==b?this.parent.height():parseInt(b);var c=this.logoBar.width()+30;this.topBar.css({width:c+
"px"});c=this.leftBar.height();b=(b-c)/2;this.leftBar.css({top:b+"px"});this.rightBar.css({top:b+"px"});a*=.85;this.bottomBar.css({width:a+"px"});this.buttonBarWidth=a;this.resetButtonPosition()}},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,container:{body:this.buttonBar,width:this.buttonBarWidth},extended:this.extendedBar.$bar})).sort();this.resetBottomBarWidth();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.changeColor()}.bind(this))},
resetBottomBarWidth:function(){var a=this.getButtonBarWidth();this.bottomBar.css({width:a+"px"})},getTopHeight:function(){var a=this.visible?this.topBar?this.topBar.height()+this.topBar.top():0:0;thumbnail&&(a+=thumbnail.getTopHeight());return a},getButtonBarWidth:function(){for(var a=0,b=0;b<this.buttons.length;b++){var c=this.buttons.get(b);c.$parent==this.buttonBar&&(a+=c.width()+10)}return a},afterButtonClick:function(a){this._super(a)},show:function(){if(this.isRenderToolbar&&!this.isMoving&&
!this.visible)if(this._super(),isIE8())this.leftBar.css({display:"block"}),this.rightBar.css({display:"block"});else{var a=transformCSS({tran:{x:0,y:0}});animateOnce(this.leftBar,a,500);a=transformCSS({tran:{x:0,y:0}});animateOnce(this.rightBar,a,500)}},hide:function(a){if(this.isRenderToolbar&&!this.isMoving&&this.visible)if(this._super(),isIE8())this.leftBar.css({display:"none"}),this.rightBar.css({display:"none"});else{var b=transformCSS({tran:{x:-this.leftBar.width(),y:0}});a?animateOnce(this.leftBar,
b,500):this.leftBar.css(b);b=transformCSS({tran:{x:this.rightBar.width(),y:0}});a?animateOnce(this.rightBar,b,500):this.rightBar.css(b)}},changeLanguage:function(){this.buttons.each(function(a){a.changeLanguage()});this.resetBottomBarWidth()},showFirstOrLast:function(){if(bookConfig.flipshortcutbutton&&this.isRenderToolbar){var a=-1<BookInfo.getCurrentPages().indexOf(bookConfig.totalPageCount);if(bookConfig.RightToLeft){if(1==BookInfo.getCurrentPageIndex()){this.leftBar.fadeIn(200);this.rightBar.fadeOut(200);
return}if(a){this.leftBar.fadeOut(200);this.rightBar.fadeIn(200);return}}else{if(1==BookInfo.getCurrentPageIndex()){this.leftBar.fadeOut(200);this.rightBar.fadeIn(200);return}if(a){this.leftBar.fadeIn(200);this.rightBar.fadeOut(200);return}}this.leftBar.fadeIn(200);this.rightBar.fadeIn(200)}},resetFlipshortcutbutton:function(){this.isRenderToolbar&&bookType!=BookType.catalog_book&&(bookConfig.flipshortcutbutton?(this.parent.has(this.leftBar).length||(this.parent.append(this.leftBar),this.parent.append(this.rightBar)),
this.showFirstOrLast()):(this.leftBar.fadeOut(200),this.rightBar.fadeOut(200)))}}).extend("Toolbar");
...
"font-size":"20px"}),$("body").append("<img style='margin-top:45px;width:98px;height:98px;' src='"+uiBaseURL+"only-wechat.svg'/><p style='margin-top:35px;'>"+bookConfig.OnlyOpenInIframeInfo+"</p>")):initStage()}else alert(getLanguage("msgConfigMissing","Configuration file is missing, unable to open the book.")),function(){window.location=window.location.href}.delay(500);eval(DeString("f341819f83944fb222ea09f0eaa26b06d7198f1c00b6cd49"))}
