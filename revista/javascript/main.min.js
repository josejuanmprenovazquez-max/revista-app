...
e&&h.push(g[k]);return h.length?f[d]=h:delete f[d],this}};a.exports=c},function(a,b,c){var d,e,f;!function(g,h){e=[a,c(0),c(2),c(1)];d=h;void 0!==(f="function"==typeof d?d.apply(b,e):d)&&(a.exports=f)}(0,function(g,h,k,m){function l(w){return w&&w.__esModule?w:{default:w}}function n(w,v){if("function"!=typeof v&&null!==v)throw new TypeError("Super expression must either be null or a function, not "+typeof v);w.prototype=Object.create(v&&v.prototype,{constructor:{value:w,enumerable:!1,writable:!0,
configurable:!0}});v&&(Object.setPrototypeOf?Object.setPrototypeOf(w,v):w.__proto__=v)}function p(w,v){w="data-clipboard-"+w;if(v.hasAttribute(w))return v.getAttribute(w)}var q=l(h);h=l(k);var r=l(m),t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(w){return typeof w}:function(w){return w&&"function"==typeof Symbol&&w.constructor===Symbol&&w!==Symbol.prototype?"symbol":typeof w},u=function(){function w(v,x){for(var z=0;z<x.length;z++){var y=x[z];y.enumerable=y.enumerable||!1;
y.configurable=!0;"value"in y&&(y.writable=!0);Object.defineProperty(v,y.key,y)}}return function(v,x,z){return x&&w(v.prototype,x),z&&w(v,z),v}}();m=function(w){function v(x,z){if(!(this instanceof v))throw new TypeError("Cannot call a class as a function");var y=(v.__proto__||Object.getPrototypeOf(v)).call(this);if(!this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");y=!y||"object"!=typeof y&&"function"!=typeof y?this:y;return y.resolveOptions(z),y.listenClick(x),
y}return n(v,w),u(v,[{key:"resolveOptions",value:function(){var x=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};this.action="function"==typeof x.action?x.action:this.defaultAction;this.target="function"==typeof x.target?x.target:this.defaultTarget;this.text="function"==typeof x.text?x.text:this.defaultText;this.container="object"===t(x.container)?x.container:document.body}},{key:"listenClick",value:function(x){var z=this;this.listener=(0,r.default)(x,"click",function(y){return z.onClick(y)})}},
{key:"onClick",value:function(x){x=x.delegateTarget||x.currentTarget;this.clipboardAction&&(this.clipboardAction=null);this.clipboardAction=new q.default({action:this.action(x),target:this.target(x),text:this.text(x),container:this.container,trigger:x,emitter:this})}},{key:"defaultAction",value:function(x){return p("action",x)}},{key:"defaultTarget",value:function(x){if(x=p("target",x))return document.querySelector(x)}},{key:"defaultText",value:function(x){return p("text",x)}},{key:"destroy",value:function(){this.listener.destroy();
this.clipboardAction&&(this.clipboardAction.destroy(),this.clipboardAction=null)}}],[{key:"isSupported",value:function(){var x=0<arguments.length&&void 0!==arguments[0]?arguments[0]:["copy","cut"],z=!!document.queryCommandSupported;return("string"==typeof x?[x]:x).forEach(function(y){z=z&&!!document.queryCommandSupported(y)}),z}}]),v}(h.default);g.exports=m})},function(a,b){"undefined"==typeof Element||Element.prototype.matches||(b=Element.prototype,b.matches=b.matchesSelector||b.mozMatchesSelector||
...
function(){c.width=this.naturalWidth;c.height=this.naturalHeight;c.onResize();c.parent.append(c.leftBotton);c.parent.append(c.rightBotton);bookConfig.isFirstLastShortcutVisible&&(c.parent.append(c.firstButton),c.parent.append(c.lastButton))};this.setButtonIcon()},setButtonIcon:function(){var a=this,b,c,d,e,f,g,h,k,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return b=a.hasColorConfiguration(),c=function(n,p){var q,r,t,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){if(1==
w.nextAddress){if(!b)return w.return(a.getImageUrl(a.getImageMap()[n][p]));q=a.getColorConfiguration(p);r=q.color;t=q.bgColor;u=global.templeteName;return w.yield(a.processImageWithTemplate(n,p,r,t,u),2)}return w.return(w.yieldResult)})},d=$jscomp,e=d.makeIterator,l.yield(Promise.all([c("left","normal"),c("right","normal"),c("left","down"),c("right","down")]),2);f=e.call(d,l.yieldResult);g=f.next().value;h=f.next().value;k=f.next().value;m=f.next().value;a.createButtonIcons(g,h,k,m);l.jumpToEnd()})},
...
$(document).add(a).off("mouseup.addLocalFile touchend.addLocalFile");if(q){u=q.width();var w=q.height();32>u&&q.width(32);12>w&&q.height(12);q.find(".TextFile")[0].click();c.resizeZoomFrame(q);u=c.parseObject(q[0]);c.parseObject(c.zoomFrame[0]);c.fileCookies.push({key:e,page:b,fileLeft:u.left,fileTop:u.top,fileWidth:u.width,fileHeight:u.height,imgWidth:null,imgHeight:null,src:null});c.addLocalStorage(c.fileName,c.parseJSON(c.fileCookies))}void 0!=c.onCreated&&c.onCreated[1].call(c.onCreated[0])})})},
...
(function(a){function b(g,h){g=g.querySelectorAll("canvas");var k=h.querySelectorAll("canvas"),m=[];g.forEach(function(l,n){var p=k[n];if(p){p.width=l.width;p.height=l.height;l=l.toDataURL();var q=new Image;n=new Promise(function(r){q.onload=function(){p.getContext("2d").drawImage(q,0,0);r()};q.onerror=function(){return r()}});q.src=l;m.push(n)}});return Promise.all(m).then(function(){})}var c=0,d={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},e={};a.fn.printArea=function(g){a.extend(e,d,g);c++;a("[id^=printArea_]").remove();e.id="printArea_"+c;var h=a(this),k=f.getPrintWindow();f.write(k.doc,h);b(a(this)[0],k.doc).then(function(){function m(){n&&n();f.print(k)}var l=a(k.doc).find("img"),n=g&&"function"===typeof g.onReady?g.onReady:null;if(0===l.length)m();else{var p=0;l.each(function(q,r){if(r.complete)p++,p===l.length&&m();else a(r).on("load error",function(){p++;p===l.length&&
...
"strict")+'.dtd">'},getHead:function(){var g="";e.extraHead&&e.extraHead.replace(/([^,]+)/g,function(h){g+=h});return"<head><title>"+e.popTitle+"</title>"+g+"</head>"},getBody:function(g){var h="",k=e.retainAttr;g.each(function(){for(var m=f.getFormData(a(this)),l="",n=0;n<k.length;n++){var p=a(m).attr(k[n]);p&&(l+=(0<l.length?" ":"")+k[n]+"='"+p+"'")}h+="<div "+l+">"+a(m).html()+"</div>"});return"<body>"+h+"</body>"},getFormData:function(g){var h=g.clone(),k=a("input,select,textarea",h);a("input,select,textarea",
g).each(function(m){var l=a(this).attr("type");"undefined"===a.type(l)&&(l=a(this).is("select")?"select":a(this).is("textarea")?"textarea":"");var n=k.eq(m);"radio"==l||"checkbox"==l?n.attr("checked",a(this).is(":checked")):"text"==l?n.attr("value",a(this).val()):"select"==l?a(this).find("option").each(function(p){a(this).is(":selected")&&a("option",n).eq(p).attr("selected",!0)}):"textarea"==l&&n.text(a(this).val())});return h},getPrintWindow:function(){switch(e.mode){case "iframe":var g=new f.Iframe;
return{win:g.contentWindow||g,doc:g.doc};case "popup":return g=new f.Popup,{win:g,doc:g.doc}}},Iframe:function(){var g=e.id;try{var h=document.createElement("iframe");document.body.appendChild(h);a(h).attr({style:"border:0;position:absolute;width:0px;height:0px;right:0px;top:0px;",id:g,src:"#"+(new Date).getTime()});h.doc=null;h.doc=h.contentDocument?h.contentDocument:h.contentWindow?h.contentWindow.document:h.document}catch(k){throw k+". iframes may not be supported in this browser.";}if(null==h.doc)throw"Cannot find document.";
...
handleBtnDrag:function(a){function b(p){this.isDraging=!0;n=!1;m=e.getBoundingClientRect();p=p.center;h=p.x-m.x;k=p.y-m.y;$(e).css({cursor:"move"})}function c(p){if(this.isDraging){var q=Math.abs(p.center.y-(m.y+k));if(5<Math.abs(p.center.x-(m.x+h))||5<q)n=!0;var r=p.center;p=f.width();q=f.height();var t=e,u=$(t).outerWidth(),w=$(t).outerHeight();t=l.isChatBotBtnTipsVisible?r.x-h:r.x-u/2;r=l.isChatBotBtnTipsVisible?r.y-k:r.y-w/2;t=Math.min(p-u,Math.max(0,t));r=Math.min(q-w,Math.max(0,r));newRight=
Math.min(p-t-u,Math.max(p,t));newBottom=Math.min(q-r-w,Math.max(q,r));$(e).css({left:t+"px",top:r+"px",right:"initial",bottom:"initial"});l.chatBotBtnTips[0]&&(p=l.chatBotBtnTips[0].getBoundingClientRect(),l.chatBotBtnTips.css({left:t-p.width-8+"px",right:"initial",bottom:window.innerHeight-r-m.height+"px"}))}}function d(){this.isDraging=!1;$(e).css({cursor:"pointer"})}var e=a.$el,f=a.parent,g=a.callback;a=new Hammer(e);a.add(new Hammer.Pan({threshold:0,pointers:0}));var h=0,k=0,m,l=this,n=!1;a.on("panstart panmove panend",
function(p){p.preventDefault();switch(p.type){case "panstart":b(p);break;case "panmove":c(p);break;case "panend":d(p)}});a.on("tap",function(p){n||g&&g(p)})},hidePopupTips:function(){this.chatBotBtnTips&&(this.isChatBotBtnTipsVisible=!1,this.chatBotBtnTips.fadeOut(),this.setPopupTipsVisible("false"))},getPopupTipsVisible:function(){var a=getHashParams("chatbotVisible");if(a&&"true"==a)return!1;try{var b=window.localStorage.getItem("isChatbotPopupTipsVisible");return b?JSON.parse(b):!0}catch(c){}},
setPopupTipsVisible:function(a){try{window.localStorage.setItem("isChatbotPopupTipsVisible",a)}catch(b){}},handleBoxDrag:function(a){function b(m){this.isDraging=!0;var l=g.getBoundingClientRect();m=m.center;h=m.x-l.x;k=m.y-l.y;$(e).css({cursor:"move",width:"100%",height:"100%"})}function c(m){if(this.isDraging){var l=m.center;m=f.width();var n=f.height(),p=$(g).outerWidth(),q=$(g).outerHeight(),r=l.x-h;l=l.y-k;r=Math.min(m-p,Math.max(0,r));l=Math.min(n-q,Math.max(0,l));$(g).css({bottom:"initial",
right:"initial",left:r+"px",top:l+"px"})}}function d(){this.isDraging=!1;$(e).css({cursor:"pointer",width:"80%",height:"50px"})}var e=a.$ele,f=a.parent,g=a.$box;a=new Hammer(e);a.add(new Hammer.Pan({threshold:0,pointers:0}));var h=0,k=0;a.on("panstart panmove panend",function(m){m.preventDefault();switch(m.type){case "panstart":b(m);break;case "panmove":c(m);break;case "panend":d(m)}})},beforeShow:function(a){this.hidePopupTips();BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"chatbot",
"chatbot button"]);this.showOrHide()},isRtl:function(){var a,b,c=/^(hebrew|arabic)$/.test(null==(a=selectedLanguage)?void 0:null==(b=a.language)?void 0:b.toLowerCase());return bookConfig.RightToLeft||c},initHtml:function(){this.container=$('<div class="chatbot-container"></div>');this.chatbotBox=$('<div id="chatbotBox" class="chatbot-box"></div>');this.chatbotDrag=$('<div id="draggableBox" class="chatbot-drag"></div>');this.chatbotResize=$('<div id="resizableBox" class="chatbot-resize"></div>');this.resizeLeft=
$('<div class="chatbot-resize-item chatbot-resize-left"></div>');this.resizeRight=$('<div class="chatbot-resize-item chatbot-resize-right"></div>');this.resizeTop=$('<div class="chatbot-resize-item chatbot-resize-top"></div>');this.resizeBottom=$('<div class="chatbot-resize-item chatbot-resize-bottom"></div>');this.resizeMask=$('<div class="chatbot-resize-mask"></div>');var a=_get(window,"website_domian_wc","https://fliphtml5.com"),b=removeUrlParts(window.location.href);bookConfig.socialShareLink&&
(b=bookConfig.socialShareLink);var c=getMetaTagValueByName("description"),d=getMetaTagValueByName("keywords");a+="/chatbot/chatbot.php";b=Metacharacter(b);d=Metacharacter(d);c=Metacharacter(c);var e=this.isRtl()?"1":"0",f,g,h=(null==(f=selectedLanguage)?void 0:null==(g=f.language)?void 0:g.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' src='"+(a+"?url="+b+"&desc="+c+"&keyword="+d+"&isRtl="+e+"&lang="+h)+"' ></iframe>");this.container.append(this.chatbotBox);
this.container.append(this.chatBotBtn);this.parent.append(this.container);this.chatbotBox.css({"box-sizing":"border-box","z-index":9999,position:"absolute",right:"120px",bottom:"50px",width:"421px",height:"740px",opacity:0,visibility:"hidden","border-radius":"12px"});this.chatbotResize.append(this.frame);this.chatbotResize.append(this.resizeLeft);this.chatbotResize.append(this.resizeRight);this.chatbotResize.append(this.resizeTop);this.chatbotResize.append(this.resizeBottom);this.chatbotResize.append(this.resizeMask);
...
(a=textForPages[a])?a.replace(/\r?\n|\r/g,"<br>"):"":""},getReaderTextByIndex:function(a){var b=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){b._readerTextPromise||(b._readerTextPromise={});b._readerTextPromise[a]||(b._readerTextPromise[a]=new Promise(function(d){if(window.readerConfig){var e=function(){if("function"===typeof window.getEditorText)return d(window.getEditorText(a)),!0};if(!e()){var f=function(){e()&&window.eventEmitter.off&&window.eventEmitter.off("initReaderPopDom",
f)};window.eventEmitter.on("initReaderPopDom",f)}}else d([])}));return c.return(b._readerTextPromise[a])})},setTextSection:function(a){var b=this;this.textSection.empty();var c=this._textSectionTaskId=Date.now();a.map(function(d){return b.setTextContentDebounced(d,c)})},setTextContent:function(a,b){var c=this,d,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress){if(b!==c._textSectionTaskId)return g.return();d=[];(e=c.getPageTextByIndex(a-1))&&d.push(e);return g.yield(c.getReaderTextByIndex(a-
1),2)}f=g.yieldResult;Array.isArray(f)?d.push.apply(d,$jscomp.arrayFromIterable(f)):f&&d.push(f);if(!d||!d.length)return g.return();d.map(function(h){b===c._textSectionTaskId&&c.appendText(h)});g.jumpToEnd()})},appendText:function(a){var b=this,c=$('<p tabindex="0" aria-live="polite" aria-atomic="true" role="region">'+a+"</p>");c[0].addEventListener("focus",function(){b.textSection[0].scrollTop=c[0].offsetTop});this.textSection.append(c)}});
...
"");for(var g=0,h=f.length;g<h;g++){var k=f[g],m=Number(String(k.match(/\[\d*/i)).slice(1));k=Number(String(k.match(/:\d*/i)).slice(1));a[60*m+k]=e}}}return a},renderLyric:function(a){this.$lyrics.html("");if("string"==typeof a)this.$lyrics.append(a);else{this.currentText=void 0;var b=0,c;for(c in a){var d=a[c];if(d){var e=$("<li>"+d+"</li>");this.$lyrics.append(e);a[c]={index:b++,text:d}}}}},updateLyric:function(a){if("string"!=typeof a&&a&&(a=a[parseInt(this.$player[0].currentTime)])){var b=a.text;
...
frmSearch.search(a))},show:function(){var a=toolBar.getTopHeight(!0);this.menu.animate({top:a},300);this.visible=!0},hide:function(){this.menu.animate({top:-60},300);this.visible=!1},showOrHide:function(){!0===this.visible?this.hide():this.show()},changeLanguage:function(){this.searchBarInput.attr("placeholder",FormInfo.getFormTitle("search"))}});var PcSearchItem=Class({create:function(a,b){b.fontColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this._super(a,b)}}).extend(SearchItem);var PcSearchForm=Class({create:function(a){this._super(a);this.expandIconColor=this.mainColor},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7*this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.searchResult.css({"border-bottom":"1px solid "+this.mainColorObj.rgba(.1)});this.pageResult.css({"border-bottom":"1px solid "+this.mainColorObj.rgba(.1)});this.progressBar.css({"background-color":this.mainColorObj.rgba(.25*
this.formOpacity)})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='search_content'></div>");this.stage.append(this.content);this.content.append(this.input);this.content.append(this.searchButton);this.content.append(this.searchPageSwiper);this.content.append(this.searchResult);this.content.append(this.$matchType);this.content.append(this.searchSwiper);
this.parent.append(this.stage)},afterSearchThumbs:function(){this.height=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1)-40;this.searchSwiper.css("height",this.height-310+"px")},afterSearchText:function(){this.height=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1)-40;this.searchSwiper.css("height",this.height-110+"px");this.searchPageSwiper.css({display:"none"})},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-
bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();this.width=287;this.height=a-40;a=toolBar.getTopHeight()+10;this.stage.css({height:this.height+"px",top:a+"px"});this.searchSwiper.css("height",this.height-110+"px");this.elements.refresh()}}).extend(PcSearchFrame);var phoneGotoPage=Class({create:function(a){this.mainColor=Color(bookConfig.toolbarColor);this.iconColor=Color(bookConfig.iconColor);this.menu=$("<div id='menu' style='position:absolute;width:100%;height:90px;z-index:98;bottom:-100px;overflow:hidden;'></div>");this.background=$("<div id='background' style='position:absolute;width:100%;height:90px;'></div>");this.contentBox=$("<div id='contentBox' class='phoneGotoPageContent' style='position:absolute;width:100%;height:90px;'></div>");this.direction=
...
a=this.getSlideIndex(this.endLeft);$("#currentPageIndexTextField").val(this.getPageNumberInfo(a));a={};this.pointer.css((a[this.direction]=this.endLeft+"px",a));this.sliderEnter.css({width:(rightToLeft?windowWidth-this.endPos.x-38:this.endPos.x-38)+"px"});this.startPos=this.endPos}}.bind(this));this.menu.on(_event.click,function(a){this.isTouchDown&&(this.isTouchDown=!1,this.endLeft&&this.endPos&&(gotoPageFun(this.getSlideIndex(this.endLeft),!1,"phone goto slider"),a={},this.pointer.css((a[this.direction]=
...
getMeta("og:image"):bookConfig.pageRestrictUrl;this.image.css({"background-image":"url("+a+")","background-size":"contain","background-repeat":"no-repeat","background-position":"center","background-color":"#ffffff"})},isRestrict:function(){return bookConfig.isEncryptionBook&&"restrict"==BookRestrict.isRestrictPage(this.index)?!0:!1},getDom:function(){return this.item},fission:function(){this.item.removeClass("highlight");this.item.addClass("focus")},merge:function(){this.item.removeClass("focus")},
setHighLight:function(a){this.index==a&&this.item.addClass("highlight")},clearHighLight:function(){this.item.removeClass("highlight")}});var ThumbnailPoint=Class({create:function(a,b){this.parent=a;this.length=14;this.pages=b;this.initHtml();this.initEvent()},initHtml:function(){this.point=$("<div class='point'></div>");this.parent.append(this.point);this.refreshPoint()},setPosition:function(a,b){this.point.css(b,a+"px")},fission:function(){this.isMerge=!1},merge:function(){this.isMerge=!0},getLength:function(){return this.length},initEvent:function(){this.point.onTap(function(){gotoPageFun(this.pages[0],!1,"thumbnail")}.bind(this));
this.point.bind("mouseover",function(){this.refreshItem();this.showItem()}.bind(this));this.point.bind("mouseleave",function(){this.hideItem()}.bind(this))},refreshPoint:function(){this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this.point.css({"background-color":this.fontColor})},refreshItem:function(){thumbnail&&thumbnail.itemInfo&&(thumbnail.itemInfo.refreshItem(this.pages,this.isMerge),thumbnail.itemInfo.setPositionByReference(this.point))},showItem:function(){thumbnail&&
thumbnail.itemInfo&&thumbnail.itemInfo.show()},hideItem:function(){thumbnail&&thumbnail.itemInfo&&thumbnail.itemInfo.hide()},setHighLight:function(){this.point.addClass("highlight")},clearHighLight:function(){this.point.removeClass("highlight")}}),ThumbnailItem=Class({create:function(a){this.parent=a;this.cellsPageIndexArray=[]},refreshItem:function(a,b){-1<this.cellsPageIndexArray.indexOf(a)&&b==this.isMerge||(this.item||(this.item=$("<div class='item_focus'></div>"),this.parent.append(this.item)),
this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor,this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor,this.item.empty(),this.pages=a,this.cells=[],this.cellsPageIndexArray=[],this.isMerge=b,this.initStructure(),this.addItem(),this.item.append(this.title),a=Color(this.mainColor).split(),this.item.css({display:"none","background-color":"rgba("+a.r+","+a.g+","+a.b+", 0.5)"}),this.title.find("span").css({"background-color":"rgba("+
a.r+","+a.g+","+a.b+", 0.5)",color:this.fontColor}),this.onResize())},initStructure:function(){this.initCells();for(var a=getShownPageNumber(this.cells[0].index),b=1;b<this.cells.length;b++)a=a+"-"+getShownPageNumber(this.cells[b].index);this.title=$("<div class='title'><span>"+a+"</span></div>")},addItem:function(){for(var a=this.cells.length,b=0;b<a;b++)this.item.append(this.cells[b].getDom())},initCells:function(){this.isMerge?this.merge():this.fission()},fission:function(){var a=new ThumbnailCell(this.item,
this.pages[0]);this.cells.push(a)},merge:function(){for(var a=0;a<this.pages.length;a++){var b=new ThumbnailCell(this.item,this.pages[a]);this.cells.push(b)}},setPositionByReference:function(a){var b=a.offset().left;a=a.width();this.item.css({left:parseInt(b+a/2-this.length/2-6)+"px"})},onResize:function(){for(var a=this.length=0;a<this.cells.length;a++)this.length+=this.cells[a].length;this.item.css({width:this.length+"px"})},show:function(){this.item&&this.item.show()},hide:function(){this.item&&
this.item.hide()},getLength:function(){return this.length}});var ThumbnailFrame=Class({create:function(a){this._super(a);this.direction=rightToLeft?Direction.right:Direction.left;this.itemArray=[];this.margin=5;this.initDefaultDom();this.initHtml();this.initEvent();this.onResize();this.initCss();bookConfig.ToolBarVisible?this.show():this.hide()},initHtml:virtual_function,initCss:function(){rightToLeft&&this.stage.addClass("rightToLeft");this.initColorCss();this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor)},
initColorCss:function(){var a=bookConfig.ToolBarAlpha,b=Color(this.mainColor).split();this.thumbnailSwiper.css({"background-color":"rgba("+b.r+","+b.g+","+b.b+", "+.5*a+")"});this.leftPageNum.css({"background-color":"rgba("+b.r+","+b.g+","+b.b+", "+.5*a+")"});this.rightPageNum.css({"background-color":"rgba("+b.r+","+b.g+","+b.b+", "+.5*a+")"});this.stage.css({color:this.fontColor})},resetFormItems:function(){for(var a=0;a<this.itemArray.length;a++)this.itemArray[a].refreshPoint(),this.itemArray[a].refreshItem()},
...
magnifier:"",
text:"iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAFtJREFUeNpi/P//PwM1ARMDlcHgN5AFixipgcpIjAudoAoZ0TQgizmR4uUrRLgMqxpGIpPNf2zeG002owbiBko42GQbGIeDzUBOwv5PTP4lVDgQpXHoxjJAgAEAl70PVLtqRkAAAAAASUVORK5CYII=",phone:"",
previous_normal:"",
previous_normal_down:"",
next_normal_down:"",
next_normal:""};Class("ButtonQueue",{create:function(a){this.container=a.container;this.extended=a.extended;this.edtNumber=a.edtNumber?a.edtNumber:{body:null,width:0,top:0,space:0};this.buttonWidth=a.buttonWidth;this.buttonTop=a.buttonTop;this.buttons=a.buttons.clone();this.buttonCount=this.buttons.length-1;this.buttons.each(function(b){b.freedom();b.hint=!0});this.pickButtons()},pickButtons:function(){this.btnFirst=this.buttons.find("first").get(0);this.btnPrevious=this.buttons.find("previous").get(0);this.btnNext=
...
Class("PCButtonQueue",{sort:function(){var a=Math.floor((this.container.width-10-(this.edtNumber.width+2*this.edtNumber.space))/this.buttonWidth),b=!1,c=10;a<this.buttonCount?(b=!0,a--):a=this.buttonCount;if(a<=this.pageButtonCount)c=this.addPageButtons(c),this.buttons.each(function(g){g==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.DEFAULT,g.title=!1);"WeChatShareButton"==g.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.DEFAULT);
"TelephoneNumberButton"==g.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.DEFAULT);g.addTo(this.extended);g.title&&(g.title.direction=TextBubble.BOTTOM)}.bind(this));else{a-=this.pageButtonCount;for(var d=Math.ceil(a/2),e=0;e<this.buttons.length;e++){var f=this.buttons.get(e);e<a?(f==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.BOTTOM,f.title=!1),"WeChatShareButton"==f.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.BOTTOM),
"TelephoneNumberButton"==f.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.BOTTOM),f.addTo(this.container.body),f.setPosition(c,this.buttonTop),c+=this.buttonWidth,e==d-1&&(c=this.addPageButtons(c)),f.title&&(f.title.direction=TextBubble.BOTTOM)):(f==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.DEFAULT,f.title=!1),"WeChatShareButton"==f.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.LEFT),
"TelephoneNumberButton"==f.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT),f.addTo(this.extended),f.title&&(f.title.direction=TextBubble.LEFT))}}b&&(this.btnMore.addTo(this.container.body),this.btnMore.setPosition(c,this.buttonTop))},addPageButtons:function(a){function b(g){g.addTo(c);g.setPosition(d,f);d+=e}var c=this.container.body,d=a,e=this.buttonWidth,f=this.buttonTop;rightToLeft?(bookConfig.enablePageBack&&b(this.btnForward),b(this.btnLast),b(this.btnNext),b(this.btnPrevious),
b(this.btnFirst),bookConfig.enablePageBack&&b(this.btnBackward)):(bookConfig.enablePageBack&&b(this.btnBackward),b(this.btnFirst),b(this.btnPrevious),b(this.btnNext),b(this.btnLast),bookConfig.enablePageBack&&b(this.btnForward));return d}}).extend("ButtonQueue");Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{BUTTON_WIDTH:30,initBar:function(){this.removeButton("thumbnail");this.topBar=$('<div class="fbTopBar" id = "fbTopBar"></div>');this.logoBar=$("<div id='logoBar' class='logoBar'></div>");this.buttonBar=$("<div class='buttonBar'></div>");this.pageBar=$("<div class='pageBar'></div>");this.edtPageNumber=$("<div class='pageNumber' id='tfPageIndex'><label><input aria-labelledby='currentPageIndex' autocomplete='off' type='text' id='currentPageIndexTextField' size='13'/></label></div>");
this.btnGotoPage=$("<div class='btnGotoPage'>GO</div>");VolumeControlBar.config={color:this.color.rgba(.5),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.BOTTOM};this.parent.append(this.topBar);this.parent.append(this.logoBar);this.topBar.append(this.buttonBar);this.topRightBar=$('<div class="topRightBar" id = "topRightBar"></div>');this.topRightBar.append(this.pageBar);this.parent.append(this.topRightBar);this.pageBar.append(this.edtPageNumber);this.pageBar.append(this.btnGotoPage);
this.initStyle();this.initPageNumber()},initStyle:function(){this.topBar.css({"background-color":this.color.rgba(.5*this.topBarAlpha)});this.pageBar.css({"background-color":this.color.rgba(.5*this.bottomBarAlpha)})},initPageNumber:function(){var a=this.edtPageNumber.find("input");a.css({color:Color(bookConfig.pageNumColor).toString()});this.btnGotoPage.css({color:Color(bookConfig.iconColor).toString()});var b=parseInt(bookConfig.totalPageCount),c=16;""==bookConfig.pageNumberCaption&&(1E4<=b&&(c=16),
1E4>b&&(c=10),1E3>b&&(c=7),100>b&&(c=4),10>b&&(c=3));a.attr("size",c);this.edtPageWidth=this.edtPageNumber.width()},setButtonTitle:function(a){if("WeChatShareButton"==a.getClassName())global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,margin:10,padding:10,arrowHeight:12,arrowWidth:12});else if("TelephoneNumberButton"==a.getClassName())global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,
margin:4,padding:15,arrowHeight:8,arrowWidth:8});else{var b=new SolidArrowTextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor});a.setTitle(b)}},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},initEvents:function(){bookConfig.ToolBarVisible&&(this._super(),this.btnGotoPage.bind("click",function(){var a=this.edtPageNumber.find("input").val();""!=a.trim()&&(a=parseInt(getRealPage(a)),isNaN(a)||gotoPageFun(a,
!1,"input"))}.bind(this)))},getLeftWidth:function(){return 10},getRightWidth:function(){return 10},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),bookConfig.ToolBarVisible?(this.topRightBar.append(this.topRightButton),this.onResize()):this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},onResize:function(a,b){if(bookConfig.ToolBarVisible){void 0==
a&&(a=this.parent.width());void 0==b&&(b=this.parent.height());this.parentWidth=a;this.parentHeight=b;b=this.logoBar.width()+20;var c=this.topRightBar.width()+60;var d=Number.between(a-2*Math.max(b,c),4*(this.BUTTON_WIDTH+5)+20,(this.buttons.length-1)*(this.BUTTON_WIDTH+5));a=(a-d)/2;this.topBar.css({left:a+"px",width:d+"px"});this.buttonBar.css({width:d-10+"px"});a<c?this.topRightBar.css({display:"none"}):this.visible&&this.topRightBar.css({display:"flex"});a<b?this.logoBar.hide():(this.visible&&
this.logoBar.show(),this.logoBar.css({left:a-b+"px"}));this.resetButtonPosition()}},resetButtonColor:function(){this._super();this.iconColor=Color(bookConfig.iconColor);this.btnGotoPage.css({color:this.iconColor.toString()})},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,buttonWidth:this.BUTTON_WIDTH,buttonTop:0,container:{body:this.buttonBar,width:this.buttonBar.width()},extended:this.extendedBar.$bar})).sort();this.resizeButtonBar();this.extendedBar.resize(this.buttonsInExtendedBar());
this.extendedBar.hide();this.buttons.each(function(a){a.changeColor();a.$button.asButton()}.bind(this))},resizeButtonBar:function(){var a=this.getButtonBarWidth();this.topBar.css({left:(this.parentWidth-a)/2+"px",width:a+"px"})},getButtonBarWidth:function(){for(var a=20,b=0;b<this.buttons.length;b++)this.buttons.get(b).$parent==this.buttonBar&&(a+=this.BUTTON_WIDTH);return a},show:function(){bookConfig.ToolBarVisible&&(this._super(),this.onResize())},hide:function(){bookConfig.ToolBarVisible&&(this._super(),
this.logoBar.hide(),this.pageBar.css({display:"none"}))}}).extend("Toolbar");
Class("PCExtendedBar",{create:function(a){this._super(a);this.$bar.css({"background-color":this.color.rgba(.5*this.toolBarAlpha)})},show:function(a){if(1!=this.isMoving&&1!=this.visible){this.visible=this.isMoving=!0;this.$bar.css({left:a.left+a.width-this.width+3+"px",top:a.top+a.height+10+"px"});var b=0;this.$bar.css({display:"block",opacity:0});var c=function(){b+=.1;this.$bar.css({opacity:b});equals(b,1)&&(c.stop(),this.isMoving=!1)}.interval(this,40)}},resize:function(a){for(var b=0;b<a.length;b++)a.get(b).setPosition(0,
10+30*b);this.width=32;this.height=30*a.length+20;this.$bar.css({width:this.width+"px",height:this.height+"px"})}}).extend("ExtendedBar");var hexcase=0,b64pad="",chrsz=8;function compareov(){var a=Date.parse(new Date);return orgt(a)===vldt(a)}function orgt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}function vldt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}
...
uiBaseURL+"only-wechat.svg'/><p style='margin-top:35px;'>"+bookConfig.OnlyOpenInIframeInfo+"</p>")):initStage()}else alert(getLanguage("msgConfigMissing","Configuration file is missing, unable to open the book.")),function(){window.location=window.location.href}.delay(500);eval(DeString("f341819f83944fb222ea09f0eaa26b06d7198f1c00b6cd49"))}
...
new ChatbotPanel(tmpContainer),(a=getHashParams("chatbotVisible"))&&"true"==a&&global.chatbotPanel.show());bookConfig.isAccessibilityButtonVisible&&!global.accessiblePanel&&(global.accessiblePanel=new PcAccessibility($("body")),0<=window.location.hash.indexOf("accessibility")&&global.accessiblePanel.show())}bookConfig.QRCode&&!global.qrButton&&(global.qrButton=new QRButton(tmpContainer));bookConfig.appLargeLogoIcon&&!global.largeAppLogo&&(global.largeAppLogo=new AppLargeLogo(bookContainer));global.backgroundObj||
(global.backgroundObj=new initBackground(tmpContainer));global.auto_player||(global.auto_player=new AutoFlip);global.bgSound||(global.bgSound=new BackgroundSound);global.volumeControlBar||(global.volumeControlBar=new VolumeControlBar(tmpContainer));!isPad()&&!isPhone()&&"brief"!=global.templeteName||global.phoneWeChatShareHelp||(global.phoneWeChatShareHelp=new PhoneWeChatShareHelp($(document.body)));global.flipPageAudio||(global.flipPageAudio=new FlipByAudio(tmpContainer,global.flipByAudio));isPad()||
isPhone()?bookConfig.EnableReportButton&&!global.reportPanel&&(global.reportPanel=new PhoneReportPanel(tmpContainer)):bookConfig.EnableReportButton&&!global.reportPanel&&(global.reportPanel=new ReportPanel(tmpContainer));bookConfig.isAccessibilityButtonVisible&&!global.accessiblePanel&&(global.accessiblePanel=new PhoneAccessibility(tmpContainer));"1"==GetQueryString("showedit")&&!global.editItNowButton&&global.EditItNowButton&&(global.editItNowButton=new EditItNowButton(tmpContainer));isPhone()||
