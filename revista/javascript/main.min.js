...
this.formOpacity)})},initHtml:function(){this.stage.append(this.title);this.stage.append(this.nailUpIcon);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='search_content'></div>");this.stage.append(this.content);this.content.append(this.input);this.content.append(this.searchButton);this.content.append(this.searchPageSwiper);this.content.append(this.searchResult);this.content.append(this.$matchType);
this.content.append(this.searchSwiper);this.parent.append(this.stage)},afterSearchThumbs:function(){this.height=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1)-40;this.searchSwiper.css("height",this.height-310+"px")},afterSearchText:function(){this.height=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1)-40;this.searchSwiper.css("height",this.height-110+"px");this.searchPageSwiper.css({display:"none"})},onResize:function(){var a=
Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();this.width=287;this.height=a-40;a=toolBar.getTopHeight()+10;this.stage.css({height:this.height+"px",top:a+"px"});this.searchSwiper.css("height",this.height-110+"px");this.elements.refresh()}}).extend(PcSearchFrame);var phoneGotoPage=Class({create:function(a){this.mainColor=Color(bookConfig.toolbarColor);this.iconColor=Color(bookConfig.iconColor);this.menu=$("<div id='menu' style='position:absolute;width:100%;height:90px;z-index:98;bottom:-100px;overflow:hidden;'></div>");this.background=$("<div id='background' style='position:absolute;width:100%;height:90px;'></div>");this.contentBox=$("<div id='contentBox' class='phoneGotoPageContent' style='position:absolute;width:100%;height:90px;'></div>");this.direction=
