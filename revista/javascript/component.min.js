...
m){function n(t){return function(r){p[t]=r;q--;0==q&&k(p)}}var p=[],q=0;do p.push(void 0),q++,c(h.value).callWhenSettled_(n(p.length-1),m),h=l.next();while(!h.done)})};return e},"es6","es3");$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var g=a[e];if(b.call(c,g,e,a))return{i:e,v:g}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
...
d[e]).css({"z-index":a}),this.book.find("#annotationDraw"+d[e]).css({"z-index":b})},clearBtnDownCase:function(){isPhone()||isPad()?this.annoBtnBox.find("div").css({background:"transparent"}):this.annoBtnBox.find("div").css({background:""});BookInfo.getBook().noteAdd&&BookInfo.getBook().noteAdd.css({opacity:""});this.bottomBox.css({display:"none"})},noteEvent:function(){this.addNote();this.defaultBottomCase()},addNote:function(){var a=this,b,c,d,e,g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==
l.nextAddress)return b=BookInfo.getBook().currentPageIndex,a.initPageConfig(),c=a.getNodePos(),d=new Date,e=d.toLocaleDateString()+" "+d.getHours()+":"+d.getMinutes()+":"+d.getSeconds(),g="id"+d.getTime(),f={index:b-1,type:"note",id:g,time:e,size:.05,position:{x:c.x/a.pageWidth,y:c.y/a.pageHeight},value:""},isPhone()||isPad()?new AnnotationAddMobileNote(a.noteParent,f,!0):new AnnotationAddNote(a.noteParent,f,!0),a.noteParent.css({display:"block"}),l.yield(global.annotationCookie.saveNoteCookie("Note",
b-1,g,f),2);global.annotationPannel.selectCase=AnnotationPannel.NONE;global.annotationPannel.setPanelIndex(0,0,"none");l.jumpToEnd()})},getNumToFixed:function(a){return Math.floor(100*a)/100},getNodePos:function(){var a=this.noteParent.find(".noteContainer"),b=[],c=0,d=0;this.pos={x:this.getNumToFixed(.25*this.pageWidth),y:this.getNumToFixed(.1*this.pageHeight)};for(var e=0;e<a.length;e++){var g={x:this.getNumToFixed($(a[e]).left()),y:this.getNumToFixed($(a[e]).top())};b.push(g)}for(;b.filter(this.filterFun.bind(this)).length;)c+=
...
this.number+"</p></div>");this.slider.append(this.sliderEnter).append(this.pointer).append(this.sliderBg);b.append(this.slider).append(this.numberBubble);var f=!1,l=0,h={x:0,y:0},k={x:0,y:0};this.pointer.bind(_event._down,function(m){f=!0}.bind(this));this.slider.bind(_event._down,function(m){$(m.target)==this.pointer[0]&&(f=!0);h=getPositionFromEvt(m);h.x<=this.minLeft&&(h.x=this.minLeft);h.x>=this.maxLeft&&(h.x=this.maxLeft);f?this.numberBubble.css({display:"block"}).css({left:this.pointer.left()+
this.minLeft-3+"px"}):(number=Math.ceil((h.x-this.minLeft-16)/this.maxWidth*this.maxNum),this.numberBubble.css({display:"block"}).css({left:h.x-17+"px"}).find(".bubbleNum").html(this.getNumber(h.x-this.minLeft-17,this.maxWidth,e,this.maxNum)),this.pointer.animate({left:h.x-this.minLeft-17+"px"},"normal",function(){this.numberBubble.css({display:"none"})}.bind(this)),this.sliderEnter.animate({width:h.x-this.minLeft-7+"px"}));k=h}.bind(this));a.bind(_event._move,function(m){if(f){k=getPositionFromEvt(m);
k.x<=this.minLeft&&(k.x=this.minLeft);k.x>=this.maxLeft&&(k.x=this.maxLeft);var n=k.x-h.x;l=this.pointer.left()+n;l=-8>l?-8:l>this.maxWidth-8?this.maxWidth-8:l;m.preventDefault();this.numberBubble.css({left:l+this.minLeft-3+"px"}).find(".bubbleNum").html(this.getNumber(k.x-this.minLeft,this.maxWidth,e,this.maxNum));this.pointer.css({left:l+"px"});this.sliderEnter.css({width:l+4+"px"});h=k}h=k}.bind(this));a.bind(_event._up,function(m){h=k;this.numberBubble.css({display:"none"});f&&(f=!1,l&&k&&(this.numberBubble.css({left:l+
this.minLeft-4+"px"}).find(".bubbleNum").html(this.getNumber(k.x-this.minLeft,this.maxWidth,e,this.maxNum)),this.pointer.css({left:l+"px"}),this.sliderEnter.css({width:l+4+"px"}),l=0))}.bind(this))},onResize:function(){this.maxWidth=windowWidth-140;this.minLeft=102;this.maxLeft=windowWidth-38;this.slider.css({width:this.maxWidth+"px"});var a=1*this.numberBubble.find(".bubbleNum").text()/this.maxNum*this.maxWidth;this.numberBubble.css({left:a+"px"});this.pointer.css({left:a-8+"px"});this.sliderEnter.css({width:a-
...
b/a,2)}:{width:Number.fixed(11.3*a/b,2),height:11.3}},printPages:function(a){var b=this,c,d,e,g,f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(!a||!a.length||!parseBool(bookConfig.PrintButtonVisible))return h.return();b.initLoadPrint();c=0;b.printArea.empty();b.printArray=[];d=function(k,m,n,p){var q=this,t,r,w,x,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return t=$("<div style='position:relative;width:100%;height:100%;'></div>"),
r=$(n),k&&-1<k.indexOf("none")&&!k.startsWith("data:image")&&m&&0>m.indexOf("none")&&(r=$(m)),void 0===p&&(p=n),u.setCatchFinallyBlocks(2),u.yield(q.createCompositeImage(r,k),4);case 4:(w=u.yieldResult)&&(r=$(w));u.leaveTryBlock(3);break;case 2:x=u.enterCatchBlock(),console.error("Canvas\u935a\u581f\u579a\u6fb6\u8fab\u89e6:",x);case 3:t.append(r);$(r).parent().css({"text-align":"center",width:"100%",height:"100%"});r.css({"text-align":"center","max-width":"100%","max-height":"100%"});"stretch"===
bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%"}):"fill"===bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%","object-fit":"cover"}):$(r).parent().css({display:"flex","justify-content":"center","align-items":"center"});q.printArray[p]=t;c++;if(c==a.length){for(v=0;v<q.printArray.length;v++)q.printArray[v]&&q.printArea.append(q.printArray[v]);q.printArea.printArea({onReady:q.hidePrintLoading.bind(q)})}u.jumpToEnd()}})};e=BookInfo.getBook().pageWidth;g=BookInfo.getBook().pageHeight;
f={};for(l=0;l<a.length;f={$jscomp$loop$prop$page$11:f.$jscomp$loop$prop$page$11},l++)f.$jscomp$loop$prop$page$11=a[l],getPageDir(f.$jscomp$loop$prop$page$11,"normal").then(function(k){return function(m){var n=e,p=g;if(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<m.indexOf("zip"))window.printLoadStack||b.initPrintStack(a),n=2*e,p=2*g;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(k.$jscomp$loop$prop$page$11).then(function(q){pageResourceLoad(k.$jscomp$loop$prop$page$11,q,d.bind(b),
n,p)}):pageResourceLoad(k.$jscomp$loop$prop$page$11,"normal",d.bind(b),n,p)}}(f));h.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d",{willReadFrequently:!0}),l=new Image;l.crossOrigin="anonymous";l.onload=function(){var h,k,m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return p.setCatchFinallyBlocks(2),g.width=l.naturalWidth,g.height=l.naturalHeight,
f.drawImage(l,0,0),p.yield(c.createWatermarkWithPageWatermark(l.naturalWidth,l.naturalHeight),4);if(2!=p.nextAddress)return(h=p.yieldResult)?f.drawImage(h,0,0):console.log("watermarkCanvas error"),k=g.toDataURL("image/png"),m=document.createElement("img"),m.src=k,m.style.cssText=a[0].style.cssText,d(m),p.leaveTryBlock(0);n=p.enterCatchBlock();console.error("canvas error:",n);d(null);p.jumpToEnd()})};l.onerror=function(){console.log("img.onerror:",b);d(null)};l.src=b}catch(h){console.log("createCompositeImage error:",
h),d(null)}})},createWatermarkWithPageWatermark:function(a,b){return new Promise(function(c){if(parseBool(bookConfig.PrintButtonVisible)&&bookConfig.printWatermark)try{var d=document.createElement("canvas");d.width=a;d.height=b;var e=new WatermarkCore(d),g=BookInfo.getBook().pageWidth,f=BookInfo.getBook().pageHeight,l=Math.min(a/g,b/f),h={position:bookConfig.watermarkPosition,width:(bookConfig.watermarkWidth||100)*l,height:(bookConfig.watermarkHeight||50)*l,opacity:bookConfig.watermarkOpacity,spacing:(bookConfig.watermarkSpacing||
50)*l,rotation:bookConfig.watermarkRotation,watermarkEdgeMargin:(bookConfig.watermarkEdgeMargin||12)*l,watermarkImage:new Image};if(bookConfig.printWatermarkFile){if(h.watermarkImage.src=bookConfig.printWatermarkFile,h.watermarkImage.onload=function(){try{bookConfig.watermarkHeight||(h.height=h.width*h.watermarkImage.height/h.watermarkImage.width),e.applyWatermark(h),c(d)}catch(k){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",k),c(null)}},h.watermarkImage.complete)try{bookConfig.watermarkHeight||
(h.height=h.width*h.watermarkImage.height/h.watermarkImage.width),e.applyWatermark(h),c(d)}catch(k){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",k),c(null)}}else c(null)}catch(k){console.error("\u9352\u6d98\u7f13\u59d8\u6751\u5d43canvas\u6fb6\u8fab\u89e6:",k),c(null)}else c(null)})},getPrintImgType:function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return b="normal",e.yield(getPageDir(a,"thumb"),2);if(3!=e.nextAddress)return c=
e.yieldResult,e.yield(getPageDir(a,"previewPage"),3);d=e.yieldResult;c.match(/none/)?d.match(/none/)||(b="previewPage"):b="thumb";return e.return(b)})},getPages:function(a){if("all"==a){a=[];for(var b=1;b<=bookConfig.totalPageCount;b++)a.push(b);return a}return"current"==a?BookInfo.getCurrentPages():getPagesByRange(a)},initPrintEvent:function(){this.button.bind(_event._click,function(a){if(!passwardType()||verifyPassward()){this.printType=this.button.printType;switch(this.printType){case "printAll":var b=
...
form_icons.print_off:uiBaseURL+"print_off.png";this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){var a=this;this.rightToLeft?(this.printAll=$("<div class='printAll item button' print='printAll'><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span><img src='"+this.printOffUrl+"'/></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+
"</span><img src='"+this.printOnUrl+"'/></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><input id='print_range_num' dir='rtl' placeholder='"+getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'></input><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><img src='"+this.printOffUrl+"'/></div>")):(this.printAll=$("<div class='printAll item button' print='printAll'><img src='"+this.printOffUrl+"'/><span class='title'>"+getLanguage("frmPrintall",
"Print All Pages")+"</span></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><img src='"+this.printOnUrl+"'/><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><img src='"+this.printOffUrl+"'/><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+
"'></input></div>"));this.printButton=$("<div class='printButton title button'>"+getLanguage("frmPrintbtn","Print")+"</div>");passwardType()&&(verifyPassward()?this.removeRestrictTips():(this.setRestrictTips(),BookEvent.bindEvent("passward",function(){verifyPassward()&&a.removeRestrictTips()})));this.printButton.printType="printCurrent";this.analysis=new AnalysisPrint(this.printButton);this.pictureListForm=new PictureListForm},setRestrictTips:function(){this.restrictedTips=$("<div class='print-restricted-tips'>*"+
getLanguage("printRestrictionTips","English"==UserGroups?"Print access for this book is restricted by the publisher.":"\u89e3\u9664\u9605\u8bfb\u9650\u5236\u540e\u624d\u80fd\u6253\u5370\u3002")+"</div>");this.restrictedTips.css({color:"#ff8d8d","line-height":"14px","margin-top":"8px","text-align":this.rightToLeft?"right":"left"});this.printButton.addClass("disable");this.printButton.removeClass("button_hover")},removeRestrictTips:function(){this.printButton.removeClass("disable");this.printButton.addClass("button_hover");
this.restrictedTips&&this.restrictedTips.remove()},pickElements:function(a){a.printOnUrl=this.printOnUrl;a.printOffUrl=this.printOffUrl;a.printAll=this.printAll;a.printCurrent=this.printCurrent;a.printRange=this.printRange;a.printButton=this.printButton;a.pictureListForm=this.pictureListForm;a.restrictedTips=this.restrictedTips},initEvent:function(a){this.printAll.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printCurrent.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));
this.printRange.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printRange.find("input").on("input propertychange change",function(){passwardType()&&!verifyPassward()||this.refreshPrintButton()}.bind(this));this.printRange.find("input").bind("mousedown touchstart pointerdown mouseover mousemove touchmove touchstend",function(b){b.stopPropagation()})},buttonEvent:function(a,b){var c=a.stage.find(".on");c.find("img").attr("src",this.printOffUrl);c.find("img")[0].colorChanged=
!1;c.removeClass("on");$(b).find("img").attr("src",this.printOnUrl);$(b).find("img")[0].colorChanged=!1;$(b).addClass("on");b=$(b).attr("print");a.printButton.printType=b;if(!passwardType()||verifyPassward())this.refreshPrintButton(),a.changeItemColor()},refreshPrintButton:function(){"printRange"!=this.printButton.printType||$("#print_range_num").val()?this.lightPrintButton():this.darkPrintButton()},lightPrintButton:function(){$(this.printButton).addClass("usable");$(this.printButton).removeClass("disable");
...
this.pickElements(a)},initElements:function(){var a=this;this.rightToLeft?(this.printAll=$("<div class='printAll item button' print='printAll'><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span><div class='print_icon'>"+this.getOffIcon()+"</div></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span><div class='print_icon'>"+this.getOnIcon()+"</div></div>"),
this.printRange=$("<div class='printRange item button' print='printRange'><div class='print_icon'>"+this.getOffIcon()+"</div><input id='print_range_num' dir='rtl' placeholder='"+getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'></input><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span></div>")):(this.printAll=$("<div class='printAll item button' print='printAll'><div class='print_icon'>"+this.getOffIcon()+"</div><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+
"</span></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><div class='print_icon'>"+this.getOnIcon()+"</div><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><div class='print_icon'>"+this.getOffIcon()+"</div><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><input id='print_range_num' placeholder='"+getLanguage("frmPrintexample",
"Example:1,3-7,12")+"'></input></div>"));this.printButton=$("<div class='printButton title button' role='button'>"+getLanguage("frmPrintbtn","Print")+"</div>");passwardType()&&(verifyPassward()?this.removeRestrictTips():(this.setRestrictTips(),BookEvent.bindEvent("passward",function(){verifyPassward()&&a.removeRestrictTips()})));this.printButton.printType="printCurrent";this.analysis=new AnalysisPrint(this.printButton);this.pictureListForm=new PictureListForm},getOffIcon:function(){return'<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="\u56fe\u5c42_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 48 48" style="enable-background:new 0 0 48 48;" xml:space="preserve"><path fill='+
this.fontColor+' d="M23.6,8.3c-8.8,0-16,7.2-16,16c0,8.8,7.2,16,16,16c8.8,0,16-7.2,16-16S32.4,8.3,23.6,8.3L23.6,8.3z M23.6,38.3c-7.7,0-14-6.3-14-14c0-7.7,6.3-14,14-14c7.7,0,14,6.3,14,14C37.6,32.1,31.3,38.3,23.6,38.3L23.6,38.3z"/></svg>'},getOnIcon:function(){return'<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="\u56fe\u5c42_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 48 48" style="enable-background:new 0 0 48 48;" xml:space="preserve"><path fill='+
...
initHtml:function(){passwardType()&&!verifyPassward()&&this.stage.append(this.elements.restrictedTips);this._super()},appendPrintOptions:function(a){this.emptyTips=$('<div><span class="empty-printoptions-tips" >'+getLanguage("emptyPrintOptionsTips","No printing options.")+"</span></div>");this.emptyTips.css({height:"150px",width:"100%",display:"flex","align-items":"center","justify-content":"center","font-size":"20px"});a=a||this.stage;bookConfig.printOptions&&0<bookConfig.printOptions.length?(0<=
bookConfig.printOptions.indexOf("all")&&a.append(this.printAll),0<=bookConfig.printOptions.indexOf("current")&&a.append(this.printCurrent),0<=bookConfig.printOptions.indexOf("range")&&a.append(this.printRange),a.append(this.printButton)):a.append(this.emptyTips)},changeIconColor:function(){this._super();this.pictureListForm.leftBtn.changeButtonColor(this.fontColor);this.pictureListForm.rightBtn.changeButtonColor(this.fontColor);this.changeItemColor()},resetColorChanged:function(){this._super();this.printAll.find("img")[0].colorChanged=
!1;this.printCurrent.find("img")[0].colorChanged=!1;this.printRange.find("img")[0].colorChanged=!1;this.pictureListForm&&(this.pictureListForm.leftBtn[0].colorChanged=!1,this.pictureListForm.rightBtn[0].colorChanged=!1)},resetIconSrc:function(){this._super();this.stage.find(".item").find("img").attr("src",this.elements.printOffUrl);this.stage.find(".on").find("img").attr("src",this.elements.printOnUrl);this.pictureListForm&&this.pictureListForm.resetBtnSrc()},changeItemColor:function(){this.printCurrent.changeButtonColor(this.fontColor);
this.printRange.changeButtonColor(this.fontColor);this.printAll.changeButtonColor(this.fontColor)},onShow:function(){this.changeIconColor()}}).extend(FadeOutFadeForm),PhonePrintForm=Class({create:function(a){this.elements=new PhonePrintElements(this);this._super(a)},onCreate:function(){this.printAll.css({"background-color":this.fontColor,color:this.mainColor});this.printCurrent.css({"background-color":this.fontColor,color:this.mainColor});this.printRange.css({"background-color":this.fontColor,color:this.mainColor});
this.printButton.css({"background-color":this.fontColor,color:this.mainColor});this.favicon&&this.favicon.changeButtonColor(this.fontColor);this._super()},initHtml:function(){this.title.append(this.close);this.stage.append(this.title);this.appendPrintOptions();this.stage.append(this.printAll);this.stage.append(this.printCurrent);this.stage.append(this.printRange);this.stage.append(this.printButton);passwardType()&&!verifyPassward()&&this.stage.append(this.elements.restrictedTips)},changeItemColor:function(){},
onShow:function(){this.favicon&&this.favicon.changeButtonColor(this.fontColor)},initEvent:function(){},appendPrintOptions:function(){this.emptyTips=$('<div><span class="no-files-prompt" >'+getLanguage("emptyPrintOptionsTips","No printing options.")+"</span></div>");this.emptyTips.css({height:"150px",width:"100%",display:"flex","align-items":"center","justify-content":"center","font-size":"20px"});var a=this.stage;bookConfig.printOptions&&0<bookConfig.printOptions.length?(0<=bookConfig.printOptions.indexOf("all")&&
a.append(this.printAll),0<=bookConfig.printOptions.indexOf("current")&&a.append(this.printCurrent),0<=bookConfig.printOptions.indexOf("range")&&a.append(this.printRange),a.append(this.printButton)):a.append(this.emptyTips)}}).extend(PhoneFormFrame),DownloadElements=Class({create:function(a){this._super(a);this.downloadOnUrl=form_icons.print_on?"data:image/png;base64,"+form_icons.print_on:uiBaseURL+"print_on.png";this.downloadOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:
uiBaseURL+"print_off.png";this.initConfig();this.initElements();this.initEvent(a);this.pickElements(a);(bookConfig.isEncryptionBook&&!BookRestrict.open||passwardType()&&!verifyPassward())&&this.setRestrictMode()},initConfig:function(){this.downloadconfig=window.downloadconfig},initElements:function(){this.rightToLeft?(this.downloadAll=$("<div class='buttondownloadAll item' download='downloadAll'><span class='title'>"+getLanguage("DownloadFullPublication","Full Publication")+"</span><img src='"+this.downloadOffUrl+
"'/></div>"),this.downloadCurrent=$("<div class='button downloadCurrent item' download='downloadCurrent'><span class='title'>"+getLanguage("DownloadCurrentPage","Current Page")+" </span><span class='page'>"+this.pageIndex+"</span><img src='"+this.downloadOffUrl+"'/></div>"),this.downloadAttachments=$("<div class='button downloadAttachments item' download='downloadAttachments'><span class='title'>"+getLanguage("DownloadAttachedFiles","Attached Files")+"</span><img src='"+this.downloadOffUrl+"'/></div>")):
(this.downloadAll=$("<div class='button downloadAll item' download='downloadAll'><img src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadFullPublication","Full Publication")+"</span></div>"),this.downloadCurrent=$("<div class='button downloadCurrent item' download='downloadCurrent'><img src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadCurrentPage","Current Page")+"</span><span class='page'>"+this.pageIndex+"</span></div>"),this.downloadAttachments=$("<div class='button downloadAttachments item' download='downloadAttachments'><img src='"+
this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadAttachedFiles","Attached Files")+"</span></div>"));this.downloadButton=$("<div class='button downloadButton title button_hover'>"+getLanguage("btnDownload","Download")+"</div>");this.restrictedTips=$("<div class='download-restricted-tips'>*"+getLanguage("downloadRestrictionTips","English"==UserGroups?"Download access for this book is restricted by the publisher.":"\u89e3\u9664\u9605\u8bfb\u9650\u5236\u540e\u624d\u80fd\u4e0b\u8f7d\u3002")+
"</div>");this.restrictedTips.css({color:"#ff8d8d","line-height":"14px","margin-top":"8px","text-align":this.rightToLeft?"right":"left"});this.noFilesAvailablePrompt=$('<div><span class="no-files-prompt" >'+getLanguage("noFilesAvailablePrompt","No Files Available!")+"</span></div>");this.noFilesAvailablePrompt.css({height:"100%",width:"100%",display:"flex","align-items":"center","justify-content":"center","font-size":"20px"});this.downloadingTips=$("<div class='download-loading-tips'>"+getLanguage("downloadingTips",
"English"===UserGroups?"Downloading...":"\u6b63\u5728\u4e0b\u8f7d\uff0c\u8bf7\u7a0d\u7b49...")+"</div>");this.downloadingTips.css({color:Color(bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor).toString(),padding:"0 20px"});this.downloadButton.downloadType=downloadconfig.hideDownloadSinglePage?downloadconfig.pdf?"downloadAll":"downloadAttachments":"downloadCurrent";this[this.downloadButton.downloadType].find("img").attr("src",this.downloadOnUrl);this[this.downloadButton.downloadType].addClass("on");
this.selectAttachments=$("<select></select>");this.selectAttachments.css({display:"downloadAttachments"===this.downloadButton.downloadType?"inline-block":"none"});var a=this.downloadconfig.attachments;if(a&&0<a.length){for(var b=0;b<a.length;b++){var c=a[b];this.selectAttachments.append($("<option value='"+c.file+"'>"+c.name+"</option>"))}var d=this;this.currentAttachmentName=this.selectAttachments.find("option")[0].innerText;this.selectAttachments.on("change",function(){d.currentAttachmentName=this.options[this.selectedIndex].innerText})}this.pictureListForm=
new PictureListForm(this.gotoPage.bind(this));this.pageIndex=this.pictureListForm.getPageIndex()},setRestrictMode:function(){var a=this;this.downloadButton.removeClass("button_hover");this.downloadButton.addClass("disable");BookEvent.bindEvent("fillBookRestrict",function(b,c){c&&a.removeRestrictMode()});BookEvent.bindEvent("passward",function(){verifyPassward()&&a.removeRestrictMode()})},removeRestrictMode:function(){this.downloadButton.removeClass("disable");this.downloadButton.addClass("button_hover");
this.restrictedTips&&this.restrictedTips.remove()},gotoPage:function(a){this.pageIndex=a;this.downloadCurrent.find(".page").html(a)},pickElements:function(a){a&&(a.downloadAll=this.downloadAll,a.downloadCurrent=this.downloadCurrent,a.downloadAttachments=this.downloadAttachments,a.selectAttachments=this.selectAttachments,a.downloadButton=this.downloadButton,a.pictureListForm=this.pictureListForm,a.noFilesAvailablePrompt=this.noFilesAvailablePrompt,a.restricted=this.restricted,a.restrictedTips=this.restrictedTips)},
get restricted(){return bookConfig.isEncryptionBook&&!BookRestrict.open},initEvent:function(a){var b=this;this.downloadAll.click(function(c){this.buttonEvent(a,c.delegateTarget)}.bind(this));this.downloadCurrent.click(function(c){this.buttonEvent(a,c.delegateTarget)}.bind(this));this.downloadAttachments.click(function(c){this.buttonEvent(a,c.delegateTarget)}.bind(this));this.verify=!1;this.downloadButton.click(function(){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(b.restricted||
passwardType()&&!verifyPassward())return d.return();c=function(){var e,g,f,l,h,k,m,n,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return b.verify=!0,e="","downloadAll"==b.downloadButton.downloadType&&(e=b.downloadconfig.pdf.url),"downloadCurrent"!=b.downloadButton.downloadType?t.jumpTo(2):t.yield(getPageDir(b.pageIndex,"normal"),3);2!=t.nextAddress&&(e=t.yieldResult);"downloadAttachments"==b.downloadButton.downloadType&&(e=b.selectAttachments[0].value);if("object"==
typeof e)if("downloadCurrent"==b.downloadButton.downloadType)b.loadImage(e,function(r,w){r=$("<a href='"+w.toDataURL("image/png")+"' download=\"page"+b.pageIndex+'.png">\n                </a>');r[0].click();r.remove()});else for(g=0;g<e.length;g++)f=e[g],bookConfig.isEncryptionBook||(f=f.removeStartFrom("?")),window.open(f,"_blank");else if("string"==typeof e&&-1<e.indexOf(".zip")&&"downloadAttachments"!==b.downloadButton.downloadType)b.downloadPdfLoadingTask&&(b.downloadPdfLoadingTask.pause(),b.downloadPdfLoadingTask.destroy()),
b.downloadPdfLoadingTask=new PdfLoadingTask(b.pageIndex,"normal",windowWidth,windowHeight,function(r){r=$("<a href="+r.toDataURL("image/png")+' download="page'+this.pageIndex+'.png"></a>');r[0].click();r.remove()}.bind(b)),b.downloadPdfLoadingTask.start();else if(-1<e.indexOf(".js"))pageResourceLoad(b.pageIndex,"normal",function(r,w,x,v){r=$("<a href="+r+' download="page'+this.pageIndex+'.png"></a>');r[0].click();r.remove()}.bind(b));else if("downloadCurrent"==b.downloadButton.downloadType&&isSupportWebp&&
!bookConfig.isEncryptionBook&&(e=e.removeStartFrom("?"),-1<e.indexOf("webp")&&(e+="?x-oss-process=image/format,jpg")),e.match(/^none/))l=document.createElement("canvas"),h=l.getContext("2d",{willReadFrequently:!0}),l.width=bookConfig.largePageWidth,l.height=bookConfig.largePageWidth,h.fillStyle=bookConfig.pageBackgroundColor,h.fillRect(0,0,bookConfig.largePageWidth,bookConfig.largePageHeight),k=$("<a href="+l.toDataURL("image/png")+' download="page'+b.pageIndex+'.png"></a>'),k[0].click();else{m="";
"downloadCurrent"==b.downloadButton.downloadType&&(m=b.pageIndex+".jpg");"downloadAttachments"==b.downloadButton.downloadType&&(m=b.currentAttachmentName||"");if(location.protocol.match("file:"))return/^\/\//i.test(e)&&(e="https://"+e),"English"==UserGroups&&"downloadAll"==b.downloadButton.downloadType&&(n=window.location.href,e=e.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(n))),window.open(e),t.return();if("downloadAll"==b.downloadButton.downloadType)return"English"==UserGroups&&(p=window.location.href,
e=e.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(p))),bookConfig.isEncryptionBook&&(q=BookRestrict.getRestrictToken(),e=appendParamToUrl(e,"code="+q)),window.open(e,"_blank"),t.return();if(isAndroid()&&isWeChat()||isPad())return window.open(e,"_blank"),t.return();if((!isPhone()&&!isPad()||_agent_.browser.safari)&&/fliphtml5|yunzhan365|anyflip|pubhtml5/.test(location.host))return k=$('<a download="'+m+'" target="_blank" href="'+e+'"></a>'),k[0].click(),t.return();new DownloadFile({url:e,downloadName:m,
downloadButton:b.downloadButton,downloadingTips:b.downloadingTips})}t.jumpToEnd()})};b.downloadconfig.code&&!b.verify?(b.downloadPasswordPanel||(b.downloadPasswordPanel=new DownloadPasswordPanel({parent:$("body"),code:b.downloadconfig.code,callback:c})),b.downloadPasswordPanel.showOrHide()):c();d.jumpToEnd()})})},loadImage:function(a,b){var c=document.createElement("canvas"),d=c.getContext("2d",{willReadFrequently:!0});c.style.position="relative";c.width=bookConfig.largePageWidth;c.height=bookConfig.largePageHeight;
c.style.width=bookConfig.largePageWidth+"px";c.style.height=bookConfig.largePageHeight+"px";Promise.all(a.map(function(e){return new Promise(function(g,f){var l=new Image;l.crossOrigin="Anonymous";l.src=e.replace(/^http:/,"https:");l.onload=function(){return g(l)};l.onerror=function(){return f(Error("Failed to load image: "+e))}})})).then(function(e){e.forEach(function(g){var f=g.naturalWidth,l=g.naturalHeight;if(bookConfig.largePageWidth/bookConfig.largePageHeight>f/l){var h=bookConfig.largePageHeight;
var k=f/l*h}else k=bookConfig.largePageWidth,h=l/f*k;d.drawImage(g,(bookConfig.largePageWidth-k)/2,(bookConfig.largePageHeight-h)/2,k,h)});b&&b(a,c)}).catch(function(e){console.log("\u56fe\u7247\u52a0\u8f7d\u5931\u8d25:",e);b&&b(a,c)})},loadImages:function(a){var b=0,c=$("<canvas style='position:relative;'></canvas>");c.css({width:bookConfig.largePageWidth+"px",height:bookConfig.largePageHeight+"px"});c.attr("width",bookConfig.largePageWidth+"px");c.attr("height",bookConfig.largePageHeight+"px");
for(var d=0;d<imageURL.length;d++){a=imageURL[d];a=a.removeStartFrom("?");var e=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>");e.attr("src",a);e[0].onload=function(g){g=$(this);bookConfig.largePageWidth/bookConfig.largePageHeight>g[0].naturalWidth/g[0].naturalHeight?g.css({width:"auto",height:"100%"}):g.css({width:"100%",height:"auto"});c.drawImage(g);b++;b==imageURL.length&&callback&&callback(imageURL,imageURL,c,index)};e[0].onerror=function(g){b++;b==imageURL.length&&
...
window.qb&&qb.share&&qb.share(q)};k?p():b(p)}var d=navigator.appVersion;var e=1<d.split("UCBrowser/").length?1:0;var g=1<d.split("MQQBrowser/").length?2:0;var f=d.match(/MicroMessenger/i)&&"micromessenger"==d.match(/MicroMessenger/i).toString().toLowerCase();var l=g?parseFloat(d.split("MQQBrowser/")[1]):0;d=e?parseFloat(d.split("UCBrowser/")[1]):0;var h=function(){var m=navigator.userAgent;return/iphone|ipod/i.test(m)?1:/android/i.test(m)?2:0}();var k=!1;g&&5.4>l&&1==h||g&&5.3>l&&1==h?g=0:g&&5.4>
l&&2==h?g=1:e&&(10.2>d&&1==h||9.7>d&&2==h)&&(e=0);b(function(){k=!0});a.mShare=function(m){this.check=function(n,p,q){e?n():g&&!f?n():f?p():q()};this.config=m;this.init=function(n){"undefined"!=typeof n&&(this.config.type=n);try{if(e){var p=this.config;n="";p.type&&(2==h?1==p.type?n="WechatTimeline":2==p.type?n="WechatFriends":3==p.type?n="QQ":4==p.type?n="SinaWeibo":0==p.type&&(n="undefined"):1==h&&(1==p.type?n="kWeixinFriend":2==p.type?n="kWeixin":3==p.type?n="kQQ":4==p.type?n="kSinaWeibo":0==p.type&&
...
text:c});this.shareCode.find(".QRcode").empty().qrcode({width:100,height:100,render:global.isIE8()?"":"image",text:c});this.bigShareCode&&this.bigShareCode.empty().qrcode({width:160,height:160,render:global.isIE8()?"":"image",text:c})},addItem:function(a){var b=this,c,d,e,g,f,l,h,k,m,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress){if(b.added)return q.return();b.added=!0;b.sharePanel.hide();return q.yield(b.analysisShare.getList(),2)}c=q.yieldResult;console.log("ShareElements shareList",
c);if(!c||0>c.length)return q.return();d=c.filter(function(t){return"mobile"===t.filter&&!isPC()||"pc"===t.filter&&isPC()?!1:!0});if(!d.length)return b.sharePanel.show(),null==(e=b.codeBox)||e.css({left:"50%",transform:"translateX(-50%)"}),a&&a(!0),q.return();b.loading=$('<img src="'+uiBaseURL+'loading.gif" style="position: absolute;left: 0;top: 0;right: 0;bottom: 0;margin: auto;"/>');$(b.sharePanel[0].parentElement.parentElement).append(b.loading);for(g=0;g<d.length;g++)f=d[g],l=void 0,f.type&&"copy"==
f.type?(l=$("<a aria-label='"+f.title+"' tabindex='0' class='share-item' id='copy_url' data-clipboard-action='copy' title='"+f.title+"'>\n            <img src='"+f.logo+"'/>\n          </a>"),copyHref(l[0])):l=-1<f.url.indexOf("javascript")?$("<a data-type='"+f.type+"' aria-label='"+f.title+"' tabindex='0' class='share-item' onclick='"+f.url.remove("javascript:")+";return false;' title='"+f.title+"'>\n            <img src='"+f.logo+"'/>\n          </a>"):$("<a data-type='"+f.type+"' aria-label='"+
f.title+"' tabindex='0' class='share-item' target = '_blank' href='"+f.url+"' title='"+f.title+"'>\n            <img src='"+f.logo+"'/>\n          </a>"),b.sharePanel.append(l),b.itemArray.push(l),h=b,l.bind(_event._end,function(){var t=$(this).attr("title");BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),t,h.shareCurrentChecked])});for(m=k=0;m<b.itemArray.length;m++)n=b.itemArray[m],p=n.find("img")[0],p.onload=function(){k++;k==b.itemArray.length&&(b.loading.remove(),b.sharePanel.show(),
a&&a())};q.jumpToEnd()})},initEvent:function(a){this.copy1.bind(_event._click,function(){BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),getLanguage("lblCopy","Copy"),self.shareCurrentChecked]);this.copyFrom(this.linkArea)}.bind(this));this.linkArea.bind(_event._click,function(){this.linkArea.select()}.bind(this));this.shareCurrentCheck.bind(_event._click,function(){this.shareCurrentChecked=!this.shareCurrentChecked;this.afterCheckClick()}.bind(this));this.linkArea.bind("mousedown touchstart pointerdown mouseover mousemove",
...
this,b,c,d,e,g,f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return console.log("linkInputChnagedEvent"),b=a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),share_url=b,a.analysisShare.refreshList(),(c=a.analysisShare.shareList)?h.jumpTo(2):h.yield(a.analysisShare.getList(),3);2!=h.nextAddress&&(c=h.yieldResult);d=c;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$13:e.$jscomp$loop$prop$type$13},g++)f=a.itemArray[g],e.$jscomp$loop$prop$type$13=
f.attr("data-type"),(l=d.find(function(k){return function(m){return m.type===k.$jscomp$loop$prop$type$13}}(e)))&&(-1<l.url.indexOf("javascript")?f.attr("onclick",l.url.remove("javascript:")+";return false;"):f.attr("href",l.url));h.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=a.val(),copyToClipboard(a)}}},pickElements:function(a){a.itemArray=this.itemArray;a.analysisShare=this.analysisShare;a.shareList=this.shareList;a.shareCode=
this.shareCode;a.linkArea=this.linkArea;a.copy1=this.copy1;a.linkBox=this.linkBox;a.codeBox=this.codeBox;a.bigCodeBox=this.bigCodeBox;a.sharePanel=this.sharePanel;a.sharePanelTitle=this.sharePanelTitle;a.shareCurrentPageBox=this.shareCurrentPageBox;a.shareCurrentCheck=this.shareCurrentCheck;a.shareCurrentPageTitle1=this.shareCurrentPageTitle1;a.qrcode=this.qrcode;a.getQrCodeStatus=this.getQrCodeBoxStatus;a.hasQrcode=this.hasQrcode;a.hasMiniProgram=this.hasMiniProgram},changeLanguage:function(){this.sharePanelTitle.html(getLanguage("frmPanelTitle",
...
PcShareFrame=Class({create:function(a){this.elements=new ShareElements(this);this._super(a)},onCreate:function(){this.initColorCss();bookConfig.addCurrentPage&&this.content.css({height:"215px"});this._super()},initColorCss:function(){this.elements.fontColor=this.fontColor;this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor,display:"none"})},initSwiperCss:function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(a.getQrCodeStatus(),
2);(b=c.yieldResult)?bookConfig.RightToLeft?a.swiperContainer.css({"border-right":"1px solid "+a.fontColorObj.rgba(.3)}):a.swiperContainer.css({"border-left":"1px solid "+a.fontColorObj.rgba(.3)}):a.swiperContainer.css({right:"initial",left:"0px"});c.jumpToEnd()})},initSwiper:function(){this.swiperContainer=$("<div class='swiperContainer'></div>");this.shareStage=$("<div class='shareStage stage'></div>");this.shareSwiper=$("<div class='shareSwiper swiper'></div>");this.progress=$("<div class='progress'></div>");
this.progressBar=$("<div class='progressBar'></div>");this.shareSwiper.append(this.sharePanel);this.shareStage.append(this.shareSwiper);this.shareStage.append(this.progress);this.progress.append(this.progressBar);this.swiperContainer.append(this.shareStage);this.shareStage.scroll({},Direction.top,"win10")},initHtml:function(){this._super()},resetColorChanged:function(){this._super();bookConfig.addCurrentPage&&(this.shareCurrentCheck[0].colorChanged=!1,this.elements.shareCurrentChecked?this.shareCurrentCheck.attr("src",
this.elements.searchOnUrl):this.shareCurrentCheck.attr("src",this.elements.searchOffUrl))},changeIconColor:function(){this._super();this.changeItemColor()},changeItemColor:function(){this.elements.fontColor=this.fontColor;this.shareCurrentCheck.changeButtonColor(this.fontColor)},onShow:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){if(1==b.nextAddress)return b.yield(a.initSwiperCss(),2);a.changeIconColor();a.shareStage.refreshData();a.elements.addItem(function(c){a.stage[0].style.display=
"inline-block";a.setA11yAndFocus();var d;c&&(null==(d=a.swiperContainer)?0:d.length)&&a.swiperContainer.css({display:"none"})});b.jumpToEnd()})}}).extend(FadeOutFadeForm),PhoneShareForm=Class({create:function(a){this.elements=new ShareElements(this);this._super(a)},onCreate:function(){this.stage.css({color:this.fontColor});this.close.changeButtonColor(this.fontColor);this.back.css({color:this.fontColor});this.favicon&&this.favicon.changeButtonColor(this.fontColor);this._super()},initHtml:function(){var a=
"Back";"Chinese"==UserGroups&&(a="\u8fd4\u56de");a=getLanguage("btnBack",a);this.back=$("<div class='back'><img src='"+(window.zoom_icons&&zoom_icons["arrow-left"]?"data:image/png;base64,"+zoom_icons["arrow-left"]:uiBaseURL+"arrow-left.png")+"'/><span>"+a+"</span></div>");this.stage.append(this.back);this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.qrcode);this.hideQRCode()},
initSwiper:function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return a.shareSwiper=$("<div class='shareSwiper stage'></div>"),a.shareSwiperList=$("<div class='swiper'></div>"),c.yield(a.analysisShare.getList(),2);b=c.yieldResult;if(!b||0>b.length)return c.return();a.refreshSwiper(a.shareSwiperList,b);a.shareSwiper.append(a.shareSwiperList);isPhone()||isPad()?a.shareSwiper.css({"overflow-y":"auto","overflow-x":"hidden","-webkit-overflow-scrolling":"touch"}):
(a.shareSwiper.css({overflow:"hidden"}),a.shareSwiperList.css({top:0,left:0,width:"100%",position:"absolute"}),a.progress=$("<div class='progress'></div>"),a.progressBar=$("<div class='progressBar'></div>"),a.shareSwiper.append(a.progress),a.progress.append(a.progressBar),a.shareSwiper.scroll({},Direction.top));a.stage.append(a.shareSwiper);c.jumpToEnd()})},refreshSwiper:function(a,b){for(var c=b.length,d=0;d<c;d++)this.addItem(a,b[d])},addItem:function(a,b){b&&(b.fontColor=this.fontColor,(new PhoneShareItem(b)).appendTo(a))},
...
(function(){Class("VirtualList",{BOX:"virtual-list",CONTAINER:"virtual-list-container",PAGE:"virtual-page",ITEM:"virtual-item",id:"",page:1,nextHeight:0,nextWidth:0,pageCount:0,listData:[],scrollLock:!1,limitLength:[0,0],$historyList:new Map,props:{vertical:0,direction:"left",scrollModel:"pan",size:20,itemHeight:60,itemWidth:70,preLoadNum:3,bothSpacing:0,boxHeight:"unset",boxWidth:"unset",boxClassName:null,containerClassName:null,itemClassName:null,pageClassName:null,boxStyle:{},containerStyle:{},
pageStyle:{},itemStyle:{}},$parent:null,$box:null,$container:null,get isVertical(){return 1===this.props.vertical},get onePageHeight(){return this.props.size*this.props.itemHeight},get onePageWidth(){return this.props.size*this.props.itemWidth},get pageCount(){return Math.ceil(this.listData.length/this.props.size)},get maxMove(){var a=2*this.props.bothSpacing;switch(this.props.direction){case "left":return a=-1*(this.$container.innerWidth()+a-this.$box.innerWidth()),0<a?0:a;case "right":return a=
this.$container.innerWidth()+a-this.$box.innerWidth(),0>a?0:a;case "top":return a=-1*(this.$container.innerHeight()+a-this.$box.innerHeight()),0<a?0:a;case "bottom":return a=this.$container.innerHeight()+a-this.$box.innerHeight(),0>a?0:a}},create:function(a,b,c){Object.assign(this.props,{renderItem:function(e,g,f){return $("<div>\u93b4\u621e\u69f8item-"+(g+1)+"</div>")},onResize:function(e){}},b);this.id="_"+Math.random().toString(36).substring(2);var d=this.props;b=d.boxHeight;d=d.boxWidth;this.$parent=
c;this.listData=a;this.nextHeight=(this.page-1)*this.onePageHeight+("number"===typeof b?b:0);this.nextWidth=(this.page-1)*this.onePageWidth+("number"===typeof d?d:0);this.initCss();this.initHtml();this.initEvent();a=this.renderItems(this.page);this.$container.append(a)},initCss:function(){var a={},b={};updateStyleSheetBatch((b["#"+this.id+"."+this.BOX]=(a.width=""+this.props.boxWidth+("number"===typeof this.props.boxWidth?"px":""),a.height=""+this.props.boxHeight+("number"===typeof this.props.boxHeight?
"px":""),a["box-sizing"]="border-box",a["."+this.CONTAINER]={width:this.isVertical?"100%":this.props.itemWidth*this.listData.length+"px",height:this.isVertical?this.props.itemHeight*this.listData.length+"px":"100%",position:"relative","box-sizing":"border-box"},a["[class^="+this.PAGE+"]"]={":first-of-type":{"padding-left":this.props.bothSpacing+"px"},":last-of-type":{"padding-right":this.props.bothSpacing+"px"}},a["[class^="+this.ITEM+"]"]={width:this.isVertical?"unset":this.props.itemWidth+"px",
height:this.isVertical?this.props.itemHeight+"px":"unset"},a["."+this.CONTAINER+", [class^="+this.PAGE+"]"]={display:"flex","flex-direction":this.isVertical?"column":"row"},a),b));a={};a=(a["#"+this.id+"."+this.BOX]=this.props.boxStyle,a["."+this.CONTAINER]=this.props.containerStyle,a["[class^="+this.PAGE+"]"]=this.props.pageStyle,a["[class^="+this.ITEM+"]"]=this.props.itemStyle,a);for(selectText in a)handlePropStyle(""+((new RegExp(this.id)).test(selectText)?selectText:"#"+this.id+" "+selectText),
a[selectText])},resize:function(){var a=this,b=this.props.onResize(this.setProps.bind(this));this.$historyList.clear();this.$container.html("");var c={},d={};updateStyleSheetBatch((d["#"+this.id+"."+this.BOX]=(c.width=""+this.props.boxWidth+("number"===typeof this.props.boxWidth?"px":""),c.height=""+this.props.boxHeight+("number"===typeof this.props.boxHeight?"px":""),c["."+this.CONTAINER]={width:this.isVertical?"100%":this.props.itemWidth*this.listData.length+"px",height:this.isVertical?this.props.itemHeight*
this.listData.length+"px":"100%","box-sizing":"border-box"},c["[class^="+this.ITEM+"]"]={width:this.isVertical?"unset":this.props.itemWidth+"px",height:this.isVertical?this.props.itemHeight+"px":"unset"},c["."+this.CONTAINER+", [class^="+this.PAGE+"]"]={display:"flex","flex-direction":this.isVertical?"column":"row"},c),d));b&&(b.hasOwnProperty("renderIndex")&&this.renderItemsByIndex(b.renderIndex),b.hasOwnProperty("callback")&&"function"===typeof b.callback&&b.callback());setTimeout(function(){a.computeLimitLength()},
200)},initHtml:function(){var a=this;this.$box=$("<div id="+this.id+' class="'+this.BOX+'"></div>');this.$container=$('<div class="'+this.CONTAINER+'"></div>');this.$box.append(this.$container);this.$parent&&this.$parent.append(this.$box);this.props.boxClassName&&this.$box.addClass(this.props.boxClassName);this.props.containerClassName&&this.$container.addClass(this.props.containerClassName);this.$box.ready(function(){a.computeLimitLength()})},setProps:function(a){if(a){for(var b=$jscomp.makeIterator(["boxWidth",
"boxHeight","itemWidth"]),c=b.next();!c.done;c=b.next())c=c.value,a.hasOwnProperty(c)&&(this.props[c]=a[c]);b=$jscomp.makeIterator(["listData"]);for(c=b.next();!c.done;c=b.next())c=c.value,this.hasOwnProperty(c)&&(this[c]=a[c])}},renderItems:function(a){a=void 0===a?1:a;var b=(a-1)*this.props.size;if(this.listData[b]){for(var c=$('<div class="'+this.PAGE+"-"+a+'"></div>'),d=0;d<this.props.size;d++){var e=this.listData[b+d];e&&((e=this.createItem(e,b+d,this.listData,{itemWidth:this.props.itemWidth,
itemHeight:this.props.itemHeight}))&&c.append(e),c.addClass(this.props.pageClassName))}this.$historyList.set(a-1,c);return c}},createItem:function(a,b,c,d){var e=this.props.renderItem.apply(this.props,arguments);if(null!==e){var g=$('<div class="'+this.ITEM+"-"+(b+1)+'"></div>');g.append(e);this.props.itemClassName&&g.addClass(this.props.itemClassName);return g}},initEvent:function(){if("scroll"===this.props.scrollModel)this.$box.on("scroll",function(a){this.scrollLock||(a=$(a.target),this.isVertical?
this.verticalScrollHandle(a.scrollTop()):this.horizontalScrollHandle(a.scrollLeft()))}.bind(this));this.initScrollEvent();window.addEventListener("resize",debounce(this.resize.bind(this),500))},initScrollEvent:function(){var a=this,b=this.$container,c=new Hammer(b[0],{threshold:tmpBookConfig.upsideOnMobile()?1:10}),d=0,e=this.props.direction;c.on("panstart panmove panend pancancel",function(g){if(g&&g.pointers&&1==g.pointers.length){"panstart"===g.type&&(d=parseInt(b.css(e)));var f=0,l=tmpBookConfig.upsideOnMobile()?
g.deltaY:g.deltaX;g=tmpBookConfig.upsideOnMobile()?-1*g.deltaX:g.deltaY;switch(e){case "left":f=l;break;case "right":f=-l;break;case "top":f=g;break;case "bottom":f=-g}f=d+f;a.moveTo(f);/left|right/i.test(e)?a.horizontalScrollHandle(-1*f):a.verticalScrollHandle(-1*f)}})},moveTo:function(a,b,c){var d=this;b=void 0===b?!1:b;(void 0===c?0:c)&&this.computeLimitLength();a<this.limitLength[0]&&(a=this.limitLength[0]);a>this.limitLength[1]&&(a=this.limitLength[1]);b&&(this.$container.css("transition","all 300ms"),
setTimeout(function(){return d.$container.css("transition","")},300));this.$container.css(this.props.direction,a+"px")},computeLimitLength:function(){var a=0,b=0;/left|top/i.test(this.props.direction)?a=this.maxMove:b=this.maxMove;this.limitLength=[a,b]},verticalScrollHandle:function(a){var b=this.props,c=b.preLoadNum,d=b.boxHeight;d="number"===typeof d?d:0;b=this.page;a>=this.nextHeight?b!==this.pageCount&&(b++,this.nextHeight=(b-1)*this.onePageHeight+d,(a=this.$historyList.get(b-1))||(a=this.renderItems(b)),
this.$container.append(a),this.page=b,a=$("."+this.PAGE+"-"+(b-c)),0<a.length&&(c=(b-c)*this.onePageHeight,a.remove(),this.$container.css("padding-top",c+"px"))):a<=(b-c+1)*this.onePageHeight&&b>c&&(b--,this.nextHeight=(b-1)*this.onePageHeight+d,a=this.$historyList.get(b-c),d=this.$container[0],d.insertBefore(a[0],d.childNodes[0]),this.page=b,a=$("."+this.PAGE+"-"+(b+1)),0<a.length&&(c=(b-c)*this.onePageHeight,a.remove(),this.$container.css("padding-top",c+"px")))},horizontalScrollHandle:function(a){var b=
this.props,c=b.preLoadNum,d=b.boxWidth;d="number"===typeof d?d:0;b=this.page;a>=this.nextWidth?b!==this.pageCount&&(b++,this.nextWidth=(b-1)*this.onePageWidth+d,(a=this.$historyList.get(b-1))||(a=this.renderItems(b)),this.$container.append(a),this.page=b,a=$("."+this.PAGE+"-"+(b-c)),0<a.length&&(c=(b-c)*this.onePageWidth,a.remove(),this.$container.css("padding-left",c+"px"))):a<=(b-c+1)*this.onePageWidth&&b>c&&(b--,this.nextWidth=(b-1)*this.onePageWidth+d,(a=this.$historyList.get(b-c))||(a=this.renderItems(b-
c+1)),d=this.$container[0],d.insertBefore(a[0],d.childNodes[0]),this.page=b,a=$("."+this.PAGE+"-"+(b+1)),0<a.length&&(c=(b-c)*this.onePageWidth,a.remove(),this.$container.css("padding-left",c+"px")))},renderItemsByIndex:function(a){this.scrollLock=!0;var b=Math.ceil(a/this.props.size);a=this.props;var c=a.boxWidth,d=a.preLoadNum,e=b-1;a=b+1;1===b?(e=1,b=2,a=3):b===this.pageCount&&(e=b-2,--b,a=this.pageCount);if(!this.isVertical){this.nextWidth=(b-1)*this.onePageWidth+("number"===typeof c?c:0);(c=
this.$historyList.get(b-1))||(c=this.renderItems(b));this.page=b;var g=$("[class^="+this.PAGE+"]");0<g.length&&g.remove();this.$container.css("padding-left",(b-d+1)*this.onePageWidth+"px");(b=this.$historyList.get(e-1))||(b=this.renderItems(e));(e=this.$historyList.get(a-1))||(e=this.renderItems(a));this.$container.append(b);this.$container.append(c);this.$container.append(e);setTimeout(function(){this.scrollLock=!1}.bind(this),1E3)}}})})(window,document);
...
initEvent:function(){},onShow:function(){this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.refreshItemsImage()}}).extend(PhoneFormFrame),PhoneBookmarkForm=Class({}).extend(PhoneBookmarkFrame),TableOfContentElements=Class({create:function(a){this._super(a);this.callBack=a;this.tableItems=[];this.virtualListProps=this.virtualList=null;this.checkConfig();this.initElements();this.initEvent(a);this.pickElements(a)},checkConfig:function(){for(var a=function(d){if(d&&d.children&&0!=d.children.length)for(var e=
d.children.length,g=0;g<e;g++)d.children[g].level=parseInt(d.children[g].level)+1,a(d.children[g])},b=ols.length,c=0;c<b;c++)0==parseInt(ols[c].level)&&(ols[c].level=parseInt(ols[c].level)+1,a(ols[c]))},initElements:function(){this.searchButtonUrl=form_icons.search_form?"data:image/png;base64,"+form_icons.search_form:uiBaseURL+"search_form.png";this.input=$("<input aria-label='"+getLanguage("ariaSearchTableOfContents","search table of contents")+"' class='input_search' placeholder='"+FormInfo.getFormTitle("tableOfContent")+
"'></input>");bookConfig.RightToLeft&&this.input.attr("dir","rtl");this.searchButton=$("<img class='searchButton button' role='button' src='"+this.searchButtonUrl+"'/>");this.result=$("<p style='display:none;margin:0 27px;'>"+getLanguage("lblPages","Found Pages")+" <span style='color:"+bookConfig.searchKeywordFontColor+";'>0</span></p>");this.tableofcontentSwiper=$("<div class='stage'></div>");var a=this;this.virtualListProps={vertical:1,direction:"top",scrollModel:"scroll",size:50,itemHeight:40,
boxClassName:"toc-virtual-box",containerClassName:"toc-virtual-container",itemClassName:"toc-virtual-item",bothSpacing:0,boxHeight:"100%",boxStyle:{"overflow-y":"auto","overflow-x":"hidden","-webkit-overflow-scrolling":"touch"},onResize:function(){},renderItem:function(b,c,d,e){b=a.callBack.newItem(a.tableofcontentSwiper,b,a.refresh.bind(a));a.tableItems.push(b);return b.getItem()}};this.refreshSwiper(ols)},expandItems:function(){for(var a=0;a<this.tableItems.length;a++)this.tableItems[a].expand()},
collapseItems:function(){for(var a=0;a<this.tableItems.length;a++)this.tableItems[a].collapse()},refreshItems:function(a){for(var b=0;b<this.tableItems.length;b++)this.tableItems[b].fontColor=a,this.tableItems[b].colorObj=Color(a),this.tableItems[b].resetItemColor&&this.tableItems[b].resetItemColor()},refreshSwiper:function(a){this.tableItems=[];this.tableofcontentSwiper.empty();this.virtualList=a&&a.length?new VirtualList(a,this.virtualListProps,this.tableofcontentSwiper):null},refresh:function(){},
initEvent:function(a){this.searchButton.onTap(function(b){this.searchStart()}.bind(this));this.input.on("input propertychange change",function(b){this.searchStart();b.stopPropagation()}.bind(this));this.input.bind("mousedown touchstart pointerdown mouseover mousemove",function(b){b.stopPropagation()})},searchStart:function(){var a=this.input.val().toLowerCase();BookEvent.trigger("search",[BookInfo.getCurrentPages().join("-"),a,"table of content"]);""===a?(this.result.css({display:"none"}),this.refreshSwiper(ols)):
(a=this.matchKey(a),this.refreshSwiper(a),a.length?this.result.css({display:"none"}):this.result.css({display:"block"}))},matchKey:function(a){var b=[],c=function(d){for(var e=[],g=0;g<d.length;g++){var f={caption:d[g].caption,page:d[g].page,level:d[g].level,url:d[g].url};d[g].children&&0<d[g].children.length&&(f.children=c(d[g].children));if(0<=d[g].caption.toLowerCase().indexOf(a))e.push(f);else if(f.children&&0<f.children.length)for(var l=0;l<f.children.length;l++)e.push(f.children[l])}return e};
return b=c(ols)},pickElements:function(a){a.input=this.input;a.searchButton=this.searchButton;a.result=this.result;a.searchButtonUrl=this.searchButtonUrl;a.tableofcontentSwiper=this.tableofcontentSwiper;a.virtualList=this.virtualList;a.progress=this.progress;a.progressBar=this.progressBar},changeLanguage:function(){this.input.attr("placeholder",FormInfo.getFormTitle("tableOfContent"))}}).extend(FormElements),PcTableOfContentFrame=Class({create:function(a){this.elements=new TableOfContentElements(this);
...
this.videoList[0].title+"</span><p class='description'>"+this.videoList[0].description+"</p></div>")},initSwiper:function(){if(this.videoList&&!(1>=this.videoList.length)){this.videoListTitle=$("<sapn class='title'>"+getLanguage("frmVideoListTitle","Video list")+"</span>");this.videoSwiper=$("<div class='videoSwiper stage'></div>");var a=$("<div class='swiper' style=''></div>");this.progress=$("<div class='progress'></div>");var b=$("<div class='progressBar'></div>");this.refreshSwiper(a,this.videoList);
this.videoSwiper.append(a);this.videoSwiper.append(this.progress);this.progress.append(b)}},refreshSwiper:function(a,b){for(var c=b.length,d=0;d<c;d++)this.addItem(a,b[d])},addItem:function(a,b){if(a&&b){var c=function(){this.playVideo(b)}.bind(this);c=new VideoGalleryItem(b,c);a.append(c.getDom())}},playVideo:function(a){BookEvent.trigger("playMedia",["video gallery",BookInfo.getCurrentPages().join("-"),a.id,a.type,(new Date).getTime()]);var b=getProtocal();if("youtube"===a.type){var c=getYouTubeIdFromUrl(a.id);
c=b+"www.youtube.com/embed/"+c+"?autoplay=1&wmode=transparent"}"vimeo"===a.type&&(c=getVimeoIdFromUrl(a.id),c=b+"player.vimeo.com/video/"+c+"?autoplay=1&wmode=transparent&portrait=0");this.video.attr("src",c);b=this.info.find(".description");this.info.find(".title").html(a.title);b.html(a.description)},initEvent:function(a){this.videoSwiper&&(isPhone()||isPad()?this.videoSwiper.scroll({},Direction.left):this.videoSwiper.scroll({},Direction.top,"win10"))},pickElements:function(a){a.videoList=this.videoList;
...
this.setImageCss(this.images[this.index]),this.moving=!0,this.newImg.fadeIn(300,function(){this.oldImg&&this.oldImg.fadeOut();this.oldImg=this.newImg;this.moving=!1}.bind(this)))},initImages:function(){for(var a=0;a<this.photoArray.length;a++){var b=$("<img src='"+this.photoArray[a]+"'/>"),c=$('<div id="thumb'+a+'" class="thumbBox"><img src=\''+this.photoArray[a]+'\'/><div class="thumbBG"></div></div>');this.images.push(b);this.thumbnails.push(c)}},setThumbnal:function(){this.thumbLeft=0;this.thumbLeft=
65*this.thumbnails.length>this.pageWidth?this.thumbLeft:(this.pageWidth-65*this.thumbnails.length)/2;for(var a=0;a<this.thumbnails.length;a++){var b=this.thumbnails[a],c=b.find("img");this.thumbEvent(b);c.css({position:"relative",width:"100%",height:"100%","object-fit":"contain"});this.setThumbImg(c,b);b.css({left:this.thumbLeft+"px"});this.thumbContainer.append(b);this.thumbLeft+=65}},setThumbImg:function(a,b){a.on("load",function(c,d){d.append(c)}.bind(this,a,b))},setPhotoImage:function(){var a=
this.images[this.index];a.on("load",function(b,c){for(var d=0;d<b.images.length;d++)b.images[b.index]!=b.images[d]&&b.images[d].css({display:"none"});return function(){b.setImageCss(c)}}(this,a))},setImageCss:function(a){this.imgTop=this.imgLeft=0;this.imgRadio=a[0].naturalWidth/a[0].naturalHeight;this.windowRadio=this.pageWidth/(this.pageHeight-80);this.imgHeight=this.imgWidth=this.radio=0;this.resetImageCss(a);a.css({width:this.imgWidth+"px",height:this.imgHeight+"px",left:0,top:0});this.imgContainer.css({width:this.imgWidth+
"px",height:this.imgHeight+"px",left:this.imgLeft,top:this.imgTop+"px"});this.leftBtn.css({top:(this.imgHeight-38)/2+"px"});this.rightBtn.css({top:(this.imgHeight-38)/2+"px"});this.imgContainer.append(a)},resetImageCss:function(a){this.imgRadio>this.windowRadio?(a[0].naturalWidth<this.pageWidth?(this.imgHeight=a[0].naturalHeight,this.imgWidth=a[0].naturalWidth,this.imgLeft=(this.pageWidth-this.imgWidth-16)/2):(this.imgWidth=this.pageWidth-16,this.radio=this.pageWidth/a[0].naturalWidth,this.imgHeight=
a[0].naturalHeight*this.radio,this.imgLeft=0),this.imgTop=(this.pageHeight-this.imgHeight-80)/2):a[0].naturalHeight<this.pageHeight-80?(this.imgWidth=a[0].naturalWidth,this.imgHeight=a[0].naturalHeight,this.imgLeft=(this.pageWidth-this.imgWidth-16)/2,this.imgTop=(this.pageHeight-this.imgHeight-80)/2):(this.imgHeight=this.pageHeight-80,this.radio=this.imgHeight/a[0].naturalHeight,this.imgWidth=a[0].naturalWidth*this.radio,this.imgLeft=(this.pageWidth-this.imgWidth-16)/2,this.imgTop=0)},show:function(){this.visible=
!0;this.stage.fadeIn(200);this.autoPlay();this.setA11y();this.stage.focus();FormManager.register(this)},hide:function(){this.visible=!1;this.stage.fadeOut(200);this.interval&&this.interval.stop();this.stopAutoPlay();this.close&&this.close.off("keydown.a11y");this.leftBtn&&this.leftBtn.off("keydown.a11y");this.rightBtn&&this.rightBtn.off("keydown.a11y");if(this.thumbnails)for(var a=0;a<this.thumbnails.length;a++)this.thumbnails[a].off("keydown.a11y");FormManager.unregister(this)},showOrHide:function(){this.visible?
this.hide():this.show()},setA11y:function(){this.close&&(this.close.attr("tabindex",0),this.close.off("keydown.a11y").on("keydown.a11y",function(c){"Enter"!==c.key&&" "!==c.key||$(this).trigger("click")}));this.leftBtn&&(this.leftBtn.attr("tabindex",0),this.leftBtn.off("keydown.a11y").on("keydown.a11y",function(c){"Enter"!==c.key&&" "!==c.key||$(this).trigger("click")}));this.rightBtn&&(this.rightBtn.attr("tabindex",0),this.rightBtn.off("keydown.a11y").on("keydown.a11y",function(c){"Enter"!==c.key&&
" "!==c.key||$(this).trigger("click")}));if(this.thumbnails)for(var a=0;a<this.thumbnails.length;a++){var b=this.thumbnails[a];b.attr("tabindex",0);b.off("keydown.a11y").on("keydown.a11y",function(c){"Enter"!==c.key&&" "!==c.key||$(this).trigger("click")})}this.stage.attr("tabindex",-1)}});
...
function resizeComponents(){if(global.printBody)printBody.onResize();if(global.downLoadBody)downLoadBody.onResize();if(global.helpBody)helpBody.onResize();if(global.aboutBody)aboutBody.onResize();if(global.sharePanel)sharePanel.onResize();if(global.languagePanel)languagePanel.onResize();if(global.frmTableOfContent)frmTableOfContent.onResize();if(global.bookmark)bookmark.onResize();if(bookConfig.AnnotationButtonVisible&&global.annotationPannel)global.annotationPannel.onResize()};var PcAboutForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super();this.bookReadTimesVisible()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor});this.content.css({"background-color":this.fontColor,color:this.mainColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='about_content'></div>");
this.initTitleList();this.stage.append(this.content);this.content2=$("<div class='content2'></div>");this.content.append(this.content2);this.content1=$("<div class='content1' style='display:none;'></div>");this.content.append(this.content1);this.content1.append(this.author);this.content1.append(this.address);this.content1.append(this.email);this.content1.append(this.website);this.content1.append(this.mobile);this.initSwiper();this.initLogo();this.content2.append(this.aboutSwiper);this._super()},bookReadTimesVisible:function(){var a=
setInterval(function(){try{this.ReadTimes=global.aboutReadTimes?global.aboutReadTimes:0,0<this.ReadTimes?(this.content1.css("height","300px"),this.content1.append(this.views),clearInterval(a)):10<this.elements.iRead&&clearInterval(a)}catch(b){}}.bind(this),1E3)},initTitleList:function(){this.titleList=$("<div class='title_list'></div>");this.titleList.append(this.descriptionTitle);this.titleList.append(this.contactTitle);(bookConfig.CompanyLogoFile||bookConfig.AboutDescription)&&this.content.append(this.titleList)},
initSwiper:function(){this.aboutSwiper=$("<div class='aboutSwiper stage'></div>");this.aboutSwiperList=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar' style='background:"+this.mainColorObj.rgba(.5)+"'></div>");this.aboutSwiper.append(this.aboutSwiperList);this.aboutSwiperList.append(this.description);this.aboutSwiper.append(this.progress);this.progress.append(this.progressBar);bookConfig.CompanyLogoFile?this.aboutSwiper.css({width:"270px"}):
this.content2.css({padding:"0"});this.aboutSwiper.scroll({},Direction.top,"win10")},initLogo:function(){bookConfig.CompanyLogoFile||bookConfig.AboutDescription?(this.content.find(this.titleList)[0]||this.content.prepend(this.titleList),bookConfig.CompanyLogoFile&&this.aboutSwiper.css({width:"270px"}),this.content.find(this.content2)[0]||this.content.append(this.content2),bookConfig.CompanyLogoFile&&!this.content2.find(this.logo)[0]&&this.content2.prepend(this.logo),bookConfig.AboutDescription&&this.aboutSwiper&&
this.aboutSwiper.refreshData()):(this.content.find(this.content2)[0]&&this.content2.remove(),this.content.find(this.titleList)[0]&&this.titleList.remove(),this.showContact())},showContact:function(){this.descriptionTitle.removeClass("focus");this.contactTitle.addClass("focus");this.descriptionTitle.css("border-bottom","none");this.contactTitle.css("border-bottom","2px solid "+this.mainColor);this.content1.show();this.content2.hide()},showDescription:function(){this.contactTitle.removeClass("focus");
this.descriptionTitle.addClass("focus");this.descriptionTitle.css("border-bottom","2px solid "+this.mainColor);this.contactTitle.css("border-bottom","none");this.content2.show();this.aboutSwiper.refreshData();this.content1.hide()},onShow:function(){this._super();bookConfig.CompanyLogoFile||bookConfig.AboutDescription?this.showDescription():this.showContact();this.aboutSwiper.refreshData()}}).extend(PcAboutFrame);var PcBookmarkItem=Class({create:function(a,b){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;a.fontColor=this.mainColor;this._super(a,b)}}).extend(BookmarkItem);var PcBookmarkListPanel=Class({create:function(a){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor);this._super(a)},onCreate:function(){this.progressBar.css({"background-color":this.mainColor})},newItem:function(a){return new PcBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel);var PcBookmarkForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this._super();this.stage.css({"background-color":this.fontColor,color:this.mainColor});this.content.css({"background-color":this.fontColor,color:this.mainColor,padding:"0 10px"});this.leftAddPage.css({"background-color":this.mainColor,color:this.fontColor});this.rightAddPage.css({"background-color":this.mainColor,color:this.fontColor});this.remove.css({"background-color":this.mainColor,
color:this.fontColor});this.title.css({background:this.mainColor,color:this.fontColor});this.bookmarkListTitle.css({"background-color":this.mainColorObj.rgba(.6),color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='bookmark_content'></div>");this.stage.append(this.content);var a=$("<p class='inputForm'></p>");a.append(this.input);
a.append(this.colorSelection);this.content.append(a);this.content.append(this.leftAddPage);this.content.append(this.rightAddPage);this.content.append(this.bookmarkListTitle);this.content.append(this.bookmarkListPanel.bookmarkSwiper);this.content.append(this.remove);this.parent.append(this.stage);this.refreshPanel()},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=280;this.height=
a-40;this.maxHeight=this.height-198;this.stage.css({height:this.height+"px",top:b+"px"});this.bookmarkListPanel.onResize(this.width,this.maxHeight);this.refreshPanel()}}).extend(PcBookmarkFrame);var PcHelpForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor});this.content.css({"background-color":this.fontColor,color:this.mainColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='help_content'></div>");this.stage.append(this.content);
this.content.append(this.image);this.title1&&this.content.append(this.title1);this.title2&&this.content.append(this.title2);this._super()},changeIconColor:function(){this.close&&this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);!bookConfig.helpContentFileURL&&this.image&&this.image.changeButtonColor(this.mainColor)}}).extend(PcHelpFrame);var PcPrintForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.printButton.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.content.find(".item").css({border:"1px solid "+this.fontColorObj.reduce(22)})},
initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='content'></div>");this.stage.append(this.content);this.printDiv=$("<div class='printDiv'></div>");this.appendPrintOptions(this.printDiv);this.content.append(this.printDiv);this._super()},changeItemColor:function(){this.printCurrent.changeButtonColor(this.mainColor);this.printRange.changeButtonColor(this.mainColor);
this.printAll.changeButtonColor(this.mainColor)},onShow:function(){this.changeIconColor();this.pictureListForm.leftBtn.changeButtonColor(this.mainColor);this.pictureListForm.rightBtn.changeButtonColor(this.mainColor);this.changeItemColor()}}).extend(PcPrintFrame);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.progressBar.css({"background-color":this.mainColorObj.rgba(this.formOpacity)})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):
this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='tableofcontent_content'></div>");this.stage.append(this.content);this.content.append(this.tableofcontentSwiper);this.parent.append(this.stage)},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=300;this.height=a-40;this.maxHeight=this.height-38;this.stage.css({height:this.height+"px",
top:b+"px"});this.tableofcontentSwiper.css({height:this.maxHeight+"px"});this.elements.refresh()}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.fontColor,color:this.mainColor});this.title.css({"background-color":this.mainColor,color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.video);this.stage.append(this.info);
if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);this.stage.append(a)}else this.stage.css("width","335px");this._super()}}).extend(PcVideoGalleryFrame);var PcShareForm=Class({create:function(a){this._super(a)},onCreate:function(){bookConfig.addCurrentPage&&this.content.css({height:"215px"});this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.stage.hide();this.content.css({"background-color":this.fontColor,color:this.mainColor});bookConfig.RightToLeft?this.swiperContainer.css({"border-right":"1px solid "+this.mainColorObj.rgba(.3)}):this.swiperContainer.css({"border-left":"1px solid "+
this.mainColorObj.rgba(.3)});this.codeBox.find(".qrcode").css({"background-color":this.mainColor,color:this.fontColor});this.codeBox.find(".miniProgram").css({"background-color":this.mainColor,color:this.fontColor});this.copy1.css({"background-color":this.mainColor,color:this.fontColor})},initSwiper:function(){this.swiperContainer=$("<div class='swiperContainer'></div>");this.shareStage=$("<div class='shareStage stage'></div>");this.shareSwiper=$("<div class='shareSwiper swiper'></div>");this.progress=
$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.shareSwiper.append(this.sharePanel);this.shareStage.append(this.shareSwiper);this.shareStage.append(this.progress);this.progress.append(this.progressBar);this.swiperContainer.append(this.shareStage);this.shareStage.scroll({},Direction.top,"win10")},initHtml:function(){var a=this;this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));
this.stage.append(this.close);this.content=$("<div class='share_content'></div>");this.initSwiper();this.stage.append(this.content);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);this.getQrCodeStatus().then(function(b){b&&a.content.append(a.codeBox)}).catch(function(b){console.error("Error getting QR code status:",b)});this.swiperContainer.append(this.sharePanelTitle);this.content.append(this.swiperContainer);this.linkBox.append(this.linkArea).append(this.copy1);
this.content.append(this.shareCurrentPageBox);this.content.append(this.linkBox);this._super()},changeItemColor:function(){this.elements.fontColor=this.mainColor;this.shareCurrentCheck.changeButtonColor(this.mainColor)}}).extend(PcShareFrame);var PcDownloadForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.downloadContent.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.downloadButton.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.content1.css({"border-right":"1px solid "+this.mainColorObj.rgba(.3)})},
resetColorChanged:function(){this._super()},resetIconSrc:function(){this._super()},changeIconColor:function(){this._super();this.changeItemColor()},changeItemColor:function(){this.downloadCurrent.changeButtonColor(this.mainColor);this.downloadAttachments.changeButtonColor(this.mainColor);this.downloadAll.changeButtonColor(this.mainColor);this.pictureListForm.leftBtn.changeButtonColor(this.mainColor);this.pictureListForm.rightBtn.changeButtonColor(this.mainColor)},initHtml:function(){this.stage.append(this.title);
this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.downloadContent=$("<div class='download_content'></div>");this.stage.append(this.downloadContent);this.content=$("<div class='content'></div>");this.content1=$("<div class='content1'></div>");downloadconfig.pdf&&this.content1.append(this.downloadAll);downloadconfig.hideDownloadSinglePage||this.content1.append(this.downloadCurrent);downloadconfig.attachments&&0<
downloadconfig.attachments.length&&(this.content1.append(this.downloadAttachments),this.content1.append(this.selectAttachments));this.hasFiles?this.content1.append(this.downloadButton):this.content1.append(this.noFilesAvailablePrompt);this.content2=$("<div class='content2'></div>");this.content2.append(this.pictureListForm.getDom());this.content.append(this.content1);this.content.append(this.content2);this.downloadContent.append(this.content);this._super()},gotoPage:function(a){this.pictureListForm.fillContent(a)}}).extend(PcDownloadFrame);
